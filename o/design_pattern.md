...
- [ガード節(Early Return)](cpp_idioms.md#SS_4_1_1)
- [RAII(scoped guard)](cpp_idioms.md#SS_4_1_2)
- [Copy-And-Swap](cpp_idioms.md#SS_4_1_3)
- [CRTP(curiously recurring template pattern)](cpp_idioms.md#SS_4_1_4)
- [Accessor](cpp_idioms.md#SS_4_1_5)
- [Immutable](cpp_idioms.md#SS_4_1_6)
- [NVI(non virtual interface)](cpp_idioms.md#SS_4_1_7)

[実装パターン](cpp_idioms.md#SS_4_2)

- [Pimpl](cpp_idioms.md#SS_4_2_1)
- [lightweight Pimpl](cpp_idioms.md#SS_4_2_2)
- [BitmaskType](cpp_idioms.md#SS_4_2_3)
- [Future](cpp_idioms.md#SS_4_2_4)
- [Null Object](cpp_idioms.md#SS_4_2_5)
- [Cでのクラス表現](cpp_idioms.md#SS_4_2_6)

[オブジェクト生成系デザインパターン](design_pattern.md#SS_6_1)

- [Singleton](design_pattern.md#SS_6_1_1)
- [Named Constructor](design_pattern.md#SS_6_1_2)
- [Clone(仮想コンストラクタ)](design_pattern.md#SS_6_1_3)
- [Factory](design_pattern.md#SS_6_1_4)

[オブジェクトの動作/協調に関するデザインパターン](design_pattern.md#SS_6_2)

- [Templateメソッド](design_pattern.md#SS_6_2_1)
- [Strategy](design_pattern.md#SS_6_2_2)
- [State](design_pattern.md#SS_6_2_3)
- [Observer](design_pattern.md#SS_6_2_4)
- [Visitor](design_pattern.md#SS_6_2_5)

[アーキテクチャパターン(システムレベルの構造)](design_pattern.md#SS_6_3)

- [DI(dependency injection)](design_pattern.md#SS_6_3_1)
- [MVC](design_pattern.md#SS_6_3_2)
...
## オブジェクト生成系デザインパターン <a id="SS_6_1"></a>
### Singleton <a id="SS_6_1_1"></a>
...
(「[Named Constructor](design_pattern.md#SS_6_1_2)」参照)と呼ばれる。


### Named Constructor <a id="SS_6_1_2"></a>
Named Connstructorは、[Singleton](design_pattern.md#SS_6_1_1)のようなオブジェクトを複数、生成するためのパターンである。
...
次に示したのは「[Factory](design_pattern.md#SS_6_1_4)」の例にこのパターンを適応したコードである。
...
### Clone(仮想コンストラクタ) <a id="SS_6_1_3"></a>
オブジェクトコピーによる[スライシング](cpp_idioms.md#SS_4_9_3)を回避するためのイデオムである。
...
DI(「[DI(dependency injection)](design_pattern.md#SS_6_3_1)」参照)と組み合わせて使われることが多い。

「[Templateメソッド](design_pattern.md#SS_6_2_1)」の例にFactoryを適用したソースコードを下記する。
...
## オブジェクトの動作/協調に関するデザインパターン <a id="SS_6_2"></a>

### Templateメソッド <a id="SS_6_2_1"></a>
...
この性質は、[Factory](design_pattern.md#SS_6_1_4)や[Named Constructor](design_pattern.md#SS_6_1_2)の実装には不可欠であるが、
...
あるいは、[DI(dependency injection)](design_pattern.md#SS_6_3_1)と組み合わせて、下記のような改善も有用である。
...
GUIアプリケーションを[MVC](design_pattern.md#SS_6_3_2)で実装する場合のModelがSubjectであり、
ViewがObserverNである。
...
これを改めるためには、「[CRTP(curiously recurring template pattern)](cpp_idioms.md#SS_4_1_4)」が必要になる。
...
単体テストが容易になる例である(「[DI(dependency injection)](design_pattern.md#SS_6_3_1)」参照)。
...
## アーキテクチャパターン(システムレベルの構造) <a id="SS_6_3"></a>

### DI(dependency injection) <a id="SS_6_3_1"></a>
メンバ関数内でクラスDependedのオブジェクトを直接、生成する
(もしくは[Singleton](design_pattern.md#SS_6_1_1)オブジェクトや静的オブジェクト(std::coutやstd::cin等)に直接アクセスする)
クラスNotDIがあるとする。
...
ViewはModelの[Observer](design_pattern.md#SS_6_2_4)であるため、ModelはViewへ依存しない。
