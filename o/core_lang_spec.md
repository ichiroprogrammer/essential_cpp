...
&emsp;&emsp; [型システムと算術の基礎](core_lang_spec.md#SS_2_1)  
&emsp;&emsp;&emsp; [基本型](core_lang_spec.md#SS_2_1_1)  
&emsp;&emsp;&emsp; [組み込み型](core_lang_spec.md#SS_2_1_2)  
&emsp;&emsp;&emsp; [算術型](core_lang_spec.md#SS_2_1_3)  
&emsp;&emsp;&emsp; [汎整数型](core_lang_spec.md#SS_2_1_4)  
&emsp;&emsp;&emsp; [整数型](core_lang_spec.md#SS_2_1_5)  
&emsp;&emsp;&emsp;&emsp; [ビットシフトにおける未定義動作](core_lang_spec.md#SS_2_1_5_1)  

&emsp;&emsp;&emsp; [算術変換](core_lang_spec.md#SS_2_1_6)  
&emsp;&emsp;&emsp; [汎整数型昇格](core_lang_spec.md#SS_2_1_7)  
&emsp;&emsp;&emsp; [汎整数型拡張](core_lang_spec.md#SS_2_1_8)  
&emsp;&emsp;&emsp; [浮動小数点型昇格](core_lang_spec.md#SS_2_1_9)  
&emsp;&emsp;&emsp; [デフォルト引数昇格](core_lang_spec.md#SS_2_1_10)  
&emsp;&emsp;&emsp; [縮小型変換](core_lang_spec.md#SS_2_1_11)  
&emsp;&emsp;&emsp; [浮動小数点型](core_lang_spec.md#SS_2_1_12)  
&emsp;&emsp;&emsp;&emsp; [浮動小数点型のダイナミックレンジ](core_lang_spec.md#SS_2_1_12_1)  
&emsp;&emsp;&emsp;&emsp; [浮動小数点の誤差](core_lang_spec.md#SS_2_1_12_2)  
&emsp;&emsp;&emsp;&emsp; [イプシロン](core_lang_spec.md#SS_2_1_12_3)  
&emsp;&emsp;&emsp;&emsp; [浮動小数点の演算エラー](core_lang_spec.md#SS_2_1_12_4)  

&emsp;&emsp; [リテラル](core_lang_spec.md#SS_2_2)  
&emsp;&emsp;&emsp; [生文字列リテラル](core_lang_spec.md#SS_2_2_1)  
&emsp;&emsp;&emsp; [2進数リテラル](core_lang_spec.md#SS_2_2_2)  
&emsp;&emsp;&emsp; [数値リテラル](core_lang_spec.md#SS_2_2_3)  
&emsp;&emsp;&emsp; [ワイド文字列](core_lang_spec.md#SS_2_2_4)  
&emsp;&emsp;&emsp; [16進浮動小数点数リテラル](core_lang_spec.md#SS_2_2_5)  
&emsp;&emsp;&emsp; [ユーザー定義リテラル](core_lang_spec.md#SS_2_2_6)  
&emsp;&emsp;&emsp;&emsp; [ユーザ定義リテラル演算子](core_lang_spec.md#SS_2_2_6_1)  
&emsp;&emsp;&emsp;&emsp; [std::string型リテラル](core_lang_spec.md#SS_2_2_6_2)  
&emsp;&emsp;&emsp;&emsp; [std::chronoのリテラル](core_lang_spec.md#SS_2_2_6_3)  
&emsp;&emsp;&emsp;&emsp; [std::complexリテラル](core_lang_spec.md#SS_2_2_6_4)  

&emsp;&emsp; [列挙型とバイト表現](core_lang_spec.md#SS_2_3)  
&emsp;&emsp;&emsp; [enum](core_lang_spec.md#SS_2_3_1)  
&emsp;&emsp;&emsp; [enum class](core_lang_spec.md#SS_2_3_2)  
&emsp;&emsp;&emsp; [スコープドenum](core_lang_spec.md#SS_2_3_3)  
&emsp;&emsp;&emsp; [underlying type](core_lang_spec.md#SS_2_3_4)  
&emsp;&emsp;&emsp; [std::byte](core_lang_spec.md#SS_2_3_5)  
&emsp;&emsp;&emsp; [using enum](core_lang_spec.md#SS_2_3_6)  

&emsp;&emsp; [型とインスタンス](core_lang_spec.md#SS_2_4)  
&emsp;&emsp;&emsp; [トリビアル型](core_lang_spec.md#SS_2_4_1)  
&emsp;&emsp;&emsp; [トリビアルに破壊可能な型](core_lang_spec.md#SS_2_4_2)  
&emsp;&emsp;&emsp; [標準レイアウト型](core_lang_spec.md#SS_2_4_3)  
&emsp;&emsp;&emsp; [集成体](core_lang_spec.md#SS_2_4_4)  
&emsp;&emsp;&emsp; [POD](core_lang_spec.md#SS_2_4_5)  
&emsp;&emsp;&emsp; [不完全型](core_lang_spec.md#SS_2_4_6)  
&emsp;&emsp;&emsp; [完全型](core_lang_spec.md#SS_2_4_7)  
&emsp;&emsp;&emsp; [ポリモーフィックなクラス](core_lang_spec.md#SS_2_4_8)  
&emsp;&emsp;&emsp; [RTTI](core_lang_spec.md#SS_2_4_9)  
&emsp;&emsp;&emsp;&emsp; [dynamic_cast](core_lang_spec.md#SS_2_4_9_1)  
&emsp;&emsp;&emsp;&emsp; [typeid](core_lang_spec.md#SS_2_4_9_2)  
&emsp;&emsp;&emsp;&emsp; [std::type_info](core_lang_spec.md#SS_2_4_9_3)  

&emsp;&emsp;&emsp; [Run-time Type Information](core_lang_spec.md#SS_2_4_10)  
&emsp;&emsp;&emsp; [インターフェースクラス](core_lang_spec.md#SS_2_4_11)  
&emsp;&emsp;&emsp; [constインスタンス](core_lang_spec.md#SS_2_4_12)  

&emsp;&emsp; [定数式とコンパイル時評価](core_lang_spec.md#SS_2_5)  
&emsp;&emsp;&emsp; [constexpr](core_lang_spec.md#SS_2_5_1)  
&emsp;&emsp;&emsp; [constexpr変数](core_lang_spec.md#SS_2_5_2)  
&emsp;&emsp;&emsp; [constexpr関数](core_lang_spec.md#SS_2_5_3)  
&emsp;&emsp;&emsp; [コア定数式](core_lang_spec.md#SS_2_5_4)  
&emsp;&emsp;&emsp; [リテラル型](core_lang_spec.md#SS_2_5_5)  
&emsp;&emsp;&emsp; [constexprインスタンス](core_lang_spec.md#SS_2_5_6)  
&emsp;&emsp;&emsp; [consteval](core_lang_spec.md#SS_2_5_7)  
&emsp;&emsp;&emsp; [constinit](core_lang_spec.md#SS_2_5_8)  
&emsp;&emsp;&emsp; [constexprラムダ](core_lang_spec.md#SS_2_5_9)  

&emsp;&emsp; [オブジェクト生成と初期化](core_lang_spec.md#SS_2_6)  
&emsp;&emsp;&emsp; [特殊メンバ関数](core_lang_spec.md#SS_2_6_1)  
&emsp;&emsp;&emsp;&emsp; [初期化子リストコンストラクタ](core_lang_spec.md#SS_2_6_1_1)  
&emsp;&emsp;&emsp;&emsp; [継承コンストラクタ](core_lang_spec.md#SS_2_6_1_2)  
&emsp;&emsp;&emsp;&emsp; [委譲コンストラクタ](core_lang_spec.md#SS_2_6_1_3)  

&emsp;&emsp;&emsp; [explicit コンストラクタと型変換制御](core_lang_spec.md#SS_2_6_2)  
&emsp;&emsp;&emsp;&emsp; [explicit](core_lang_spec.md#SS_2_6_2_1)  
&emsp;&emsp;&emsp;&emsp; [暗黙の型変換](core_lang_spec.md#SS_2_6_2_2)  
&emsp;&emsp;&emsp;&emsp; [暗黙の型変換抑止](core_lang_spec.md#SS_2_6_2_3)  
&emsp;&emsp;&emsp;&emsp; [explicit(COND)](core_lang_spec.md#SS_2_6_2_4)  
&emsp;&emsp;&emsp;&emsp; [explicit type operator()](core_lang_spec.md#SS_2_6_2_5)  

&emsp;&emsp;&emsp; [==演算子](core_lang_spec.md#SS_2_6_3)  
&emsp;&emsp;&emsp;&emsp; [メンバ==演算子](core_lang_spec.md#SS_2_6_3_1)  
&emsp;&emsp;&emsp;&emsp; [非メンバ==演算子](core_lang_spec.md#SS_2_6_3_2)  

&emsp;&emsp;&emsp; [比較演算子](core_lang_spec.md#SS_2_6_4)  
&emsp;&emsp;&emsp;&emsp; [<=>演算子](core_lang_spec.md#SS_2_6_4_1)  
&emsp;&emsp;&emsp;&emsp; [三方比較演算子](core_lang_spec.md#SS_2_6_4_2)  
&emsp;&emsp;&emsp;&emsp; [spaceship operator](core_lang_spec.md#SS_2_6_4_3)  

&emsp;&emsp;&emsp; [リスト初期化](core_lang_spec.md#SS_2_6_5)  
&emsp;&emsp;&emsp; [一様初期化](core_lang_spec.md#SS_2_6_6)  
&emsp;&emsp;&emsp; [非静的なメンバ変数の初期化](core_lang_spec.md#SS_2_6_7)  
&emsp;&emsp;&emsp;&emsp; [NSDMI](core_lang_spec.md#SS_2_6_7_1)  
&emsp;&emsp;&emsp;&emsp; [初期化子リストでの初期化](core_lang_spec.md#SS_2_6_7_2)  
&emsp;&emsp;&emsp;&emsp; [コンストラクタ内での非静的なメンバ変数の初期値の代入](core_lang_spec.md#SS_2_6_7_3)  

&emsp;&emsp;&emsp; [オブジェクトのライフタイム](core_lang_spec.md#SS_2_6_8)  
&emsp;&emsp;&emsp; [プレースメントnew](core_lang_spec.md#SS_2_6_9)  
&emsp;&emsp;&emsp; [new (std::nothrow)](core_lang_spec.md#SS_2_6_10)  

&emsp;&emsp; [値カテゴリとリファレンス](core_lang_spec.md#SS_2_7)  
&emsp;&emsp;&emsp; [expression](core_lang_spec.md#SS_2_7_1)  
&emsp;&emsp;&emsp;&emsp; [lvalue](core_lang_spec.md#SS_2_7_1_1)  
&emsp;&emsp;&emsp;&emsp; [rvalue](core_lang_spec.md#SS_2_7_1_2)  
&emsp;&emsp;&emsp;&emsp; [xvalue](core_lang_spec.md#SS_2_7_1_3)  
&emsp;&emsp;&emsp;&emsp; [prvalue](core_lang_spec.md#SS_2_7_1_4)  
&emsp;&emsp;&emsp;&emsp; [glvalue](core_lang_spec.md#SS_2_7_1_5)  

&emsp;&emsp;&emsp; [decltypeとexpression](core_lang_spec.md#SS_2_7_2)  

&emsp;&emsp; [リファレンス](core_lang_spec.md#SS_2_8)  
&emsp;&emsp;&emsp; [lvalueリファレンス](core_lang_spec.md#SS_2_8_1)  
&emsp;&emsp;&emsp; [rvalueリファレンス](core_lang_spec.md#SS_2_8_2)  
&emsp;&emsp;&emsp;&emsp; [lvalueからの代入](core_lang_spec.md#SS_2_8_2_1)  
&emsp;&emsp;&emsp;&emsp; [rvalueからの代入](core_lang_spec.md#SS_2_8_2_2)  
&emsp;&emsp;&emsp;&emsp; [std::move(lvalue)からの代入](core_lang_spec.md#SS_2_8_2_3)  

&emsp;&emsp;&emsp; [forwardingリファレンス](core_lang_spec.md#SS_2_8_3)  
&emsp;&emsp;&emsp; [ユニバーサルリファレンス](core_lang_spec.md#SS_2_8_4)  
&emsp;&emsp;&emsp; [perfect forwarding](core_lang_spec.md#SS_2_8_5)  
&emsp;&emsp;&emsp; [リファレンスcollapsing](core_lang_spec.md#SS_2_8_6)  
&emsp;&emsp;&emsp; [リファレンス修飾](core_lang_spec.md#SS_2_8_7)  
&emsp;&emsp;&emsp;&emsp; [rvalue修飾](core_lang_spec.md#SS_2_8_7_1)  
&emsp;&emsp;&emsp;&emsp; [lvalue修飾](core_lang_spec.md#SS_2_8_7_2)  

&emsp;&emsp; [構文と制御構造](core_lang_spec.md#SS_2_9)  
&emsp;&emsp;&emsp; [属性構文](core_lang_spec.md#SS_2_9_1)  
&emsp;&emsp;&emsp; [範囲for文](core_lang_spec.md#SS_2_9_2)  
&emsp;&emsp;&emsp; [構造化束縛](core_lang_spec.md#SS_2_9_3)  
&emsp;&emsp;&emsp; [初期化付きif/switch文](core_lang_spec.md#SS_2_9_4)  
&emsp;&emsp;&emsp;&emsp; [初期化付きfor文(従来のfor文)](core_lang_spec.md#SS_2_9_4_1)  
&emsp;&emsp;&emsp;&emsp; [初期化付きwhile文(従来のwhile文)](core_lang_spec.md#SS_2_9_4_2)  
&emsp;&emsp;&emsp;&emsp; [初期化付きif文](core_lang_spec.md#SS_2_9_4_3)  
&emsp;&emsp;&emsp;&emsp; [初期化付きswitch文](core_lang_spec.md#SS_2_9_4_4)  

&emsp;&emsp; [言語拡張機能](core_lang_spec.md#SS_2_10)  
&emsp;&emsp;&emsp; [コルーチン](core_lang_spec.md#SS_2_10_1)  
&emsp;&emsp;&emsp;&emsp; [co_await](core_lang_spec.md#SS_2_10_1_1)  
&emsp;&emsp;&emsp;&emsp; [co_return](core_lang_spec.md#SS_2_10_1_2)  
&emsp;&emsp;&emsp;&emsp; [co_yield](core_lang_spec.md#SS_2_10_1_3)  

&emsp;&emsp;&emsp; [モジュール](core_lang_spec.md#SS_2_10_2)  
&emsp;&emsp;&emsp; [ラムダ式](core_lang_spec.md#SS_2_10_3)  
&emsp;&emsp;&emsp;&emsp; [クロージャ](core_lang_spec.md#SS_2_10_3_1)  
&emsp;&emsp;&emsp;&emsp; [クロージャ型](core_lang_spec.md#SS_2_10_3_2)  
&emsp;&emsp;&emsp;&emsp; [一時的ラムダ](core_lang_spec.md#SS_2_10_3_3)  
&emsp;&emsp;&emsp;&emsp; [transient lambda](core_lang_spec.md#SS_2_10_3_4)  

&emsp;&emsp;&emsp; [指示付き初期化](core_lang_spec.md#SS_2_10_4)  

&emsp;&emsp; [テンプレートと型推論](core_lang_spec.md#SS_2_11)  
&emsp;&emsp;&emsp; [SFINAE](core_lang_spec.md#SS_2_11_1)  
&emsp;&emsp;&emsp; [メタ関数](core_lang_spec.md#SS_2_11_2)  
&emsp;&emsp;&emsp; [コンセプト](core_lang_spec.md#SS_2_11_3)  
&emsp;&emsp;&emsp; [パラメータパック](core_lang_spec.md#SS_2_11_4)  
&emsp;&emsp;&emsp; [畳み込み式](core_lang_spec.md#SS_2_11_5)  
&emsp;&emsp;&emsp; [ジェネリックラムダ](core_lang_spec.md#SS_2_11_6)  
&emsp;&emsp;&emsp; [クラステンプレートのテンプレート引数の型推論](core_lang_spec.md#SS_2_11_7)  
&emsp;&emsp;&emsp; [CTAD(Class Template Argument Deduction)](core_lang_spec.md#SS_2_11_8)  
&emsp;&emsp;&emsp; [テンプレートの型推論ガイド](core_lang_spec.md#SS_2_11_9)  
&emsp;&emsp;&emsp; [変数テンプレート](core_lang_spec.md#SS_2_11_10)  
&emsp;&emsp;&emsp; [エイリアステンプレート](core_lang_spec.md#SS_2_11_11)  
&emsp;&emsp;&emsp; [constexpr if文](core_lang_spec.md#SS_2_11_12)  
&emsp;&emsp;&emsp; [autoパラメータによる関数テンプレートの簡易定義](core_lang_spec.md#SS_2_11_13)  
&emsp;&emsp;&emsp; [auto](core_lang_spec.md#SS_2_11_14)  
&emsp;&emsp;&emsp; [decltype](core_lang_spec.md#SS_2_11_15)  
&emsp;&emsp;&emsp; [decltype(auto)](core_lang_spec.md#SS_2_11_16)  
&emsp;&emsp;&emsp; [戻り値型を後置する関数宣言](core_lang_spec.md#SS_2_11_17)  
&emsp;&emsp;&emsp; [関数の戻り値型auto](core_lang_spec.md#SS_2_11_18)  
&emsp;&emsp;&emsp; [後置戻り値型auto](core_lang_spec.md#SS_2_11_19)  

&emsp;&emsp; [name lookupと継承構造](core_lang_spec.md#SS_2_12)  
&emsp;&emsp;&emsp; [ルックアップ](core_lang_spec.md#SS_2_12_1)  
&emsp;&emsp;&emsp; [name lookup](core_lang_spec.md#SS_2_12_2)  
&emsp;&emsp;&emsp; [two phase name lookup](core_lang_spec.md#SS_2_12_3)  
&emsp;&emsp;&emsp; [実引数依存探索](core_lang_spec.md#SS_2_12_4)  
&emsp;&emsp;&emsp; [ADL](core_lang_spec.md#SS_2_12_5)  
&emsp;&emsp;&emsp; [関連名前空間](core_lang_spec.md#SS_2_12_6)  
&emsp;&emsp;&emsp; [修飾付き関数呼び出し](core_lang_spec.md#SS_2_12_7)  
&emsp;&emsp;&emsp; [hidden-friend関数](core_lang_spec.md#SS_2_12_8)  
&emsp;&emsp;&emsp; [name-hiding](core_lang_spec.md#SS_2_12_9)  
&emsp;&emsp;&emsp; [ダイヤモンド継承](core_lang_spec.md#SS_2_12_10)  
&emsp;&emsp;&emsp; [仮想継承](core_lang_spec.md#SS_2_12_11)  
&emsp;&emsp;&emsp; [仮想基底](core_lang_spec.md#SS_2_12_12)  
&emsp;&emsp;&emsp; [ドミナンス](core_lang_spec.md#SS_2_12_13)  
&emsp;&emsp;&emsp;&emsp; [ダイヤモンド継承を含まない場合](core_lang_spec.md#SS_2_12_13_1)  
&emsp;&emsp;&emsp;&emsp; [ダイヤモンド継承かつそれが仮想継承でない場合](core_lang_spec.md#SS_2_12_13_2)  
&emsp;&emsp;&emsp;&emsp; [ダイヤモンド継承かつそれが仮想継承である場合](core_lang_spec.md#SS_2_12_13_3)  

&emsp;&emsp;&emsp; [using宣言](core_lang_spec.md#SS_2_12_14)  
&emsp;&emsp;&emsp; [usingディレクティブ](core_lang_spec.md#SS_2_12_15)  

&emsp;&emsp; [エクセプション](core_lang_spec.md#SS_2_13)  
&emsp;&emsp;&emsp; [try-catch](core_lang_spec.md#SS_2_13_1)  
&emsp;&emsp;&emsp; [関数tryブロック](core_lang_spec.md#SS_2_13_2)  
&emsp;&emsp;&emsp; [エクセプションのthrow](core_lang_spec.md#SS_2_13_3)  
&emsp;&emsp;&emsp; [エクセプションの再throw](core_lang_spec.md#SS_2_13_4)  
&emsp;&emsp;&emsp; [catch-all](core_lang_spec.md#SS_2_13_5)  
&emsp;&emsp;&emsp; [noexcept](core_lang_spec.md#SS_2_13_6)  
&emsp;&emsp;&emsp; [エクセプション安全性の保証](core_lang_spec.md#SS_2_13_7)  
&emsp;&emsp;&emsp;&emsp; [no-fail保証](core_lang_spec.md#SS_2_13_7_1)  
&emsp;&emsp;&emsp;&emsp; [強い安全性の保証](core_lang_spec.md#SS_2_13_7_2)  
&emsp;&emsp;&emsp;&emsp; [基本的な安全性の保証](core_lang_spec.md#SS_2_13_7_3)  

&emsp;&emsp;&emsp; [exception-unfriendly](core_lang_spec.md#SS_2_13_8)  

&emsp;&emsp; [言語仕様の定義要素](core_lang_spec.md#SS_2_14)  
&emsp;&emsp;&emsp; [ill-formed](core_lang_spec.md#SS_2_14_1)  
&emsp;&emsp;&emsp; [well-formed](core_lang_spec.md#SS_2_14_2)  
&emsp;&emsp;&emsp; [未定義動作](core_lang_spec.md#SS_2_14_3)  
&emsp;&emsp;&emsp; [未規定動作](core_lang_spec.md#SS_2_14_4)  
&emsp;&emsp;&emsp; [未定義動作と未規定動作](core_lang_spec.md#SS_2_14_5)  
&emsp;&emsp;&emsp; [被修飾型](core_lang_spec.md#SS_2_14_6)  
&emsp;&emsp;&emsp; [実引数/仮引数](core_lang_spec.md#SS_2_14_7)  
&emsp;&emsp;&emsp; [単純代入](core_lang_spec.md#SS_2_14_8)  
&emsp;&emsp;&emsp; [one-definition rule](core_lang_spec.md#SS_2_14_9)  
&emsp;&emsp;&emsp; [ODR](core_lang_spec.md#SS_2_14_10)  
&emsp;&emsp;&emsp; [型特性キーワード](core_lang_spec.md#SS_2_14_11)  
&emsp;&emsp;&emsp;&emsp; [alignof](core_lang_spec.md#SS_2_14_11_1)  
&emsp;&emsp;&emsp;&emsp; [alignas](core_lang_spec.md#SS_2_14_11_2)  
&emsp;&emsp;&emsp;&emsp; [addressof](core_lang_spec.md#SS_2_14_11_3)  

&emsp;&emsp;&emsp; [演算子のオペランドの評価順位](core_lang_spec.md#SS_2_14_12)  

&emsp;&emsp; [その他](core_lang_spec.md#SS_2_15)  
&emsp;&emsp;&emsp; [RVO(Return Value Optimization)](core_lang_spec.md#SS_2_15_1)  
&emsp;&emsp;&emsp; [トライグラフ](core_lang_spec.md#SS_2_15_2)  
...
[組み込み型](core_lang_spec.md#SS_2_1_2)とも呼ばれることもある。

基本型は以下のに示した型によって構成される。

* [算術型](core_lang_spec.md#SS_2_1_3)
* [汎整数型](core_lang_spec.md#SS_2_1_4)
* [浮動小数点型](core_lang_spec.md#SS_2_1_12)
* void
* 上記した型のポインタ型
...
組み込み型(built-in types)は[基本型](core_lang_spec.md#SS_2_1_1)(fundamental types)の別称。

### 算術型 <a id="SS_2_1_3"></a>
算術型とは下記の型の総称である。

* [汎整数型](core_lang_spec.md#SS_2_1_4)(bool, char, int, unsigned int, long long等)
* [浮動小数点型](core_lang_spec.md#SS_2_1_12)(float、double、long double)
...
* 論理型(bool)
* 文字型(char、wchar_t等)
* [整数型](core_lang_spec.md#SS_2_1_5)(int、unsigned int、long等)
...
(注) 符号なし[整数型](core_lang_spec.md#SS_2_1_5)変数(us)をオペランドにした左ビットシフトがオーバーフローした場合、
...
算術変換は、[汎整数型昇格](core_lang_spec.md#SS_2_1_7)と通常算術変換に分けられる。
...
[一様初期化](core_lang_spec.md#SS_2_6_6)を使用することで、
変数定義時の算術変換による意図しない値の変換([縮小型変換](core_lang_spec.md#SS_2_1_11))を防ぐことができる。
...
汎整数型拡張とは[汎整数型昇格](core_lang_spec.md#SS_2_1_7)と同じ概念を指す。
...
プロトタイプを持たない関数に[算術型](core_lang_spec.md#SS_2_1_3)引数を渡す際に適用される昇格ルールの総称である。

デフォルト引数昇格には以下が含まれる。

- [汎整数型昇格](core_lang_spec.md#SS_2_1_7)
- [浮動小数点型昇格](core_lang_spec.md#SS_2_1_9)

### 縮小型変換 <a id="SS_2_1_11"></a>
縮小型変換(Narrowing Conversion) とは、あるデータ型から別のデータ型に変換する際に、
変換先の型が元の型の表現範囲を完全にカバーしていない場合に発生する変換を指す。
主に[整数型](core_lang_spec.md#SS_2_1_5)や[浮動小数点型](core_lang_spec.md#SS_2_1_12)などの値を小さな範囲の型に変換する際に起こる。
...
[リスト初期化](core_lang_spec.md#SS_2_6_5)を使うことで、このような変換によるバグの発生を防ぐことができる。
...
[ユーザ定義リテラル演算子](core_lang_spec.md#SS_2_2_6_1)により定義されたリテラルを指す。
...
このドキュメントでは、[スコープドenum](core_lang_spec.md#SS_2_3_3)に対して、C++03までのenumを非スコープドenum、
...
enum classは通常の[enum](core_lang_spec.md#SS_2_3_1)の問題を解決するためにC++11から導入された。
...
[enum class](core_lang_spec.md#SS_2_3_2)はスコープドenum(scoped enum)と呼ばれることがある。


### underlying type <a id="SS_2_3_4"></a>
underlying typeとは、enumやenum classの[汎整数型](core_lang_spec.md#SS_2_1_4)を指定できるようにするために、
...
C++17から導入された[std::byte](core_lang_spec.md#SS_2_3_5)の利便性のため、
...
[一様初期化](core_lang_spec.md#SS_2_6_6)を使用するべきだろう。
...
[整数型](core_lang_spec.md#SS_2_1_5)としての意味を持たないため、型安全性を確保する。
uint8_t型と似ているが、uint8_t型の演算による[汎整数型昇格](core_lang_spec.md#SS_2_1_7)を発生させないため、
可読性、保守性の向上が見込める。
...
* 全ての[特殊メンバ関数](core_lang_spec.md#SS_2_6_1)がデフォルトである。
* バーチャル関数や仮想継承を持たない。
* 基底クラスがある場合、基底クラスもトリビアルである。

である。その結果、トリビアル型とは、[トリビアルに破壊可能な型](core_lang_spec.md#SS_2_4_2)となる。
...
「型が[トリビアル型](core_lang_spec.md#SS_2_4_1)且つ[標準レイアウト型](core_lang_spec.md#SS_2_4_3)であること」と
「型が[POD](core_lang_spec.md#SS_2_4_5)であること」は等価であるため、C++20では、
...
### 完全型 <a id="SS_2_4_7"></a>
[不完全型](core_lang_spec.md#SS_2_4_6)ではない型を指す。

### ポリモーフィックなクラス <a id="SS_2_4_8"></a>
ポリモーフィックなクラスとは仮想関数を持つクラスや、
ポリモーフィックなクラスから派生したクラスを指す。
なお、純粋仮想関数を持つクラスは、
仮想クラスと呼ばれれる(「[インターフェースクラス](core_lang_spec.md#SS_2_4_11)」参照)。
ポリモーフィックなクラスと、
非ポリモーフィックなクラスは[RTTI](core_lang_spec.md#SS_2_4_9)との組み合わせで動作の違いが顕著となる。

非ポリモーフィックなクラスは非静的なメンバ変数が定義された順にメモリ上に配置されたレイアウトを持つ
(CPUアーキテクチャに依存したパディング領域が変数間に挿入されることもある)。
このようなクラスは[POD](core_lang_spec.md#SS_2_4_5)
(C++20では、[PODという用語は非推奨](https://cpprefjp.github.io/lang/cpp20/deprecate_pod.html)
となり、[トリビアル型](core_lang_spec.md#SS_2_4_1)と[標準レイアウト型](core_lang_spec.md#SS_2_4_3)に用語が分割された)とも呼ばれ、
C言語の構造体のレイアウトと互換性を持つことが一般的である。

ポリモーフィックなクラスは、
仮想関数呼び出しを行う(「[オーバーライドとオーバーロードの違い](cpp_idioms.md#SS_4_11_1)」参照)
ためのメモリレイアウトが必要になる。
...
* [dynamic_cast](core_lang_spec.md#SS_2_4_9_1)
* [typeid](core_lang_spec.md#SS_2_4_9_2)
* [std::type_info](core_lang_spec.md#SS_2_4_9_3)


#### dynamic_cast <a id="SS_2_4_9_1"></a>
dynamic_castは、実行時の型チェックと安全なダウンキャストを行うためのキャスト演算子であるため、
[ポリモーフィックなクラス](core_lang_spec.md#SS_2_4_8)とは密接な関係を持つ。


下記のような[ポリモーフィックなクラス](core_lang_spec.md#SS_2_4_8)に対しては、
...
一方で、下記のような非[ポリモーフィックなクラス](core_lang_spec.md#SS_2_4_8)に対しては、
...
typeidは[RTTI](core_lang_spec.md#SS_2_4_9)オブジェクトの型情報
([std::type_info](core_lang_spec.md#SS_2_4_9_3))を実行時に取得するための演算子である。
dynamic_castとは違い、
typeidのオペランドは[ポリモーフィックなクラス](core_lang_spec.md#SS_2_4_8)のインスタンスでなくても良い。
以下の例では[基本型](core_lang_spec.md#SS_2_1_1)に対するtypeidが返す[std::type_info](core_lang_spec.md#SS_2_4_9_3)の振る舞いを表す。
...
下記のような[ポリモーフィックなクラス](core_lang_spec.md#SS_2_4_8)のインスタンスに関して、
...
typeidが返す[std::type_info](core_lang_spec.md#SS_2_4_9_3)オブジェクトは下記のように振舞う。
...
[ポリモーフィックなクラス](core_lang_spec.md#SS_2_4_8)のオブジェクトをオペランドとするtypeidの実行は、
...
一方、非[ポリモーフィックなクラス](core_lang_spec.md#SS_2_4_8)のオブジェクトをオペランドとするtypeidのオペランド式は、
...
このドキュメントのコードのコンパイルに使用している[g++](cpp_idioms.md#SS_4_13_1)/[clang++](cpp_idioms.md#SS_4_13_2)では、
そのような関数は、`abi::__cxa_demangle`である。

`std::type_info::name()`と`abi::__cxa_demangle`を利用して、
オブジェクトの[被修飾型](core_lang_spec.md#SS_2_14_6)名をstd::stringオブジェクトとして取り出す関数とその使用例を以下に示す。
...
「[RTTI](core_lang_spec.md#SS_2_4_9)」を参照せよ。
...
[constexprインスタンス](core_lang_spec.md#SS_2_5_6)はconstインスタンスである。
C++03までのコンパイラに、
最適化の一環で`static const`インスタンスを[constexprインスタンス](core_lang_spec.md#SS_2_5_6)と扱うものもあった。
...
### constexpr変数 <a id="SS_2_5_2"></a>
C++11以前で定数を定義する方法は、

* マクロ定数
* [enum](core_lang_spec.md#SS_2_3_1)
...
constexpr変数がif文のオカレンスになる場合、[constexpr if文](core_lang_spec.md#SS_2_11_12)することで、
[ill-formed](core_lang_spec.md#SS_2_14_1)を使用した場合分けが可能になる。
...
1. 以下のいずれかに該当する式であること  
   ...
   - constexpr関数呼び出し
   - sizeof演算子の適用結果
   - typeid演算子の適用結果(式の値が[ポリモーフィックなクラス](core_lang_spec.md#SS_2_4_8)である場合を除く)
...
このドキュメントでは慣用的に[constexpr変数](core_lang_spec.md#SS_2_5_2)と呼んでいる概念が、コア定数式である。
...
[constexprインスタンス](core_lang_spec.md#SS_2_5_6)を生成できる。
...
[constexpr変数](core_lang_spec.md#SS_2_5_2)を引数にして、[リテラル型](core_lang_spec.md#SS_2_5_5)のconstexprコンストラクタを呼び出せば、
constexprインスタンスを生成できる。このリテラル型を使用して下記のように[ユーザー定義リテラル](core_lang_spec.md#SS_2_2_6)
...
これにより、[Static Initialization Order Fiasco(静的初期化順序問題)](cpp_idioms.md#SS_4_12_15)を回避できる。
...
constexprラムダはC++17から導入された機能であり、以下の条件を満たした[ラムダ式](core_lang_spec.md#SS_2_10_3)である。
...
* [==演算子](core_lang_spec.md#SS_2_6_3)  
  クラス内のすべてのメンバが==をサポートしている場合、`= default`とすることで自動生成される。
* [<=>演算子](core_lang_spec.md#SS_2_6_4_1)  
  すべてのメンバが[<=>演算子](core_lang_spec.md#SS_2_6_4_1)での比較可能である場合、`= default`とすることで自動生成される。 
...
* [ゼロの原則(Rule of Zero)](cpp_idioms.md#SS_4_7_1)
* [五の原則(Rule of Five)](cpp_idioms.md#SS_4_7_2)

この2つの原則(ガイドライン)の使い分けに関しては、

* リソース管理を外部([RAII(scoped guard)](cpp_idioms.md#SS_4_1_2)クラス)に任せられる場合: ゼロの法則を採用し、特殊メンバ関数を明示的に定義しない。
* リソースをクラス内で直接管理する場合: 五の法則を採用し、すべての特殊メンバ関数を適切に定義する。

とすることで安全で保守性性の高いコードを設計できる。

#### 初期化子リストコンストラクタ <a id="SS_2_6_1_1"></a>
初期化子リストコンストラクタ([リスト初期化](core_lang_spec.md#SS_2_6_5)用のコンストラクタ)とは、
{}による[リスト初期化](core_lang_spec.md#SS_2_6_5)をサポートするためのコンストラクタである。
...
- [暗黙の型変換](core_lang_spec.md#SS_2_6_2_2)
- [暗黙の型変換抑止](core_lang_spec.md#SS_2_6_2_3)
- [explicit(COND)](core_lang_spec.md#SS_2_6_2_4)
- [explicit type operator()](core_lang_spec.md#SS_2_6_2_5)

#### 暗黙の型変換 <a id="SS_2_6_2_2"></a>
この節で扱う暗黙の型変換とは、
以下に示したような「非explicitなコンストラクタを持つクラス」による暗黙の型変換を指し、
[汎整数型昇格](core_lang_spec.md#SS_2_1_7)や[算術変換](core_lang_spec.md#SS_2_1_6)等を指さない。
...
といった[セマンティクス](cpp_idioms.md#SS_4_14_1)的観点によるものである。
...
下記のコードのように[暗黙の型変換](core_lang_spec.md#SS_2_6_2_2)が起こる。
...
C++03までは、[一様初期化](core_lang_spec.md#SS_2_6_6)がサポートされていなかったため、
explicitは単一引数のコンストラクタに使用されることが一般的であった。

C++11からサポートされた[一様初期化](core_lang_spec.md#SS_2_6_6)を下記のように使用することで、
暗黙の型変換を使用できる。
...
### ==演算子 <a id="SS_2_6_3"></a>
クラスの==演算子の実装方法には、
[メンバ==演算子](core_lang_spec.md#SS_2_6_3_1)、[非メンバ==演算子](core_lang_spec.md#SS_2_6_3_2)の2つの方法がある。

#### メンバ==演算子 <a id="SS_2_6_3_1"></a>
メンバ==演算子には、[非メンバ==演算子](core_lang_spec.md#SS_2_6_3_2)に比べ、下記のようなメリットがある。
...
非メンバ==演算子には、[メンバ==演算子](core_lang_spec.md#SS_2_6_3_1)に比べ、下記のようなメリットがある。
...
* [暗黙の型変換](core_lang_spec.md#SS_2_6_2_2)を利用した以下に示すようなシンプルな記述ができる場合がある。
...
比較演算子とは、[==演算子](--)の他に、!=、 <=、>、>= <、>を指す。
C++20から導入された[<=>演算子](core_lang_spec.md#SS_2_6_4_1)の定義により、すべてが定義される。

#### <=>演算子 <a id="SS_2_6_4_1"></a>
「[std::tuppleを使用した比較演算子の実装方法](stdlib_and_concepts.md#SS_3_11_2)」
...
三方比較演算子とは[<=>演算子](core_lang_spec.md#SS_2_6_4_1)を指す。

#### spaceship operator <a id="SS_2_6_4_3"></a>
spaceship operatorとは[<=>演算子](core_lang_spec.md#SS_2_6_4_1)を指す。
...
[リスト初期化](core_lang_spec.md#SS_2_6_5)による初期化方法がC++における初期化を統一的に扱えるように設計された概念を指さす。

### 非静的なメンバ変数の初期化 <a id="SS_2_6_7"></a>
非静的なメンバ変数の初期化には下記の3つの方法がある。

* [NSDMI](core_lang_spec.md#SS_2_6_7_1)
* [初期化子リストでの初期化](core_lang_spec.md#SS_2_6_7_2)
* [コンストラクタ内での非静的なメンバ変数の初期値の代入](core_lang_spec.md#SS_2_6_7_3)

同一変数に対して、
「[NSDMI](core_lang_spec.md#SS_2_6_7_1)」と「[初期化子リストでの初期化](core_lang_spec.md#SS_2_6_7_2)」
...
constメンバ変数は、初期化子リストでの初期化か[NSDMI](core_lang_spec.md#SS_2_6_7_1)でしか初期化できない。
...
[NSDMI](core_lang_spec.md#SS_2_6_7_1)、
[初期化子リストでの初期化](core_lang_spec.md#SS_2_6_7_2)で初期化できない変数を未初期化でない状態にするための唯一の方法である。
...
* prvalue(「[rvalue](core_lang_spec.md#SS_2_7_1_2)」参照)のライフタイム
...
このような状態のリファレンスを[danglingリファレンス](cpp_idioms.md#SS_4_11_2)と呼ぶ。
同様に、このような状態のポインタを[danglingポインタ](cpp_idioms.md#SS_4_11_3)と呼ぶ。
...
* [lvalue](core_lang_spec.md#SS_2_7_1_1)
* [rvalue](core_lang_spec.md#SS_2_7_1_2)
* [xvalue](core_lang_spec.md#SS_2_7_1_3)
* [glvalue](core_lang_spec.md#SS_2_7_1_5)
* [prvalue](core_lang_spec.md#SS_2_7_1_4)
...
expressionは、[lvalue](core_lang_spec.md#SS_2_7_1_1)か[rvalue](core_lang_spec.md#SS_2_7_1_2)である。
...
* [rvalue](core_lang_spec.md#SS_2_7_1_2)でない[expression](core_lang_spec.md#SS_2_7_1)がlvalueである。

`T const&`は代入式の左辺になりは得ないがlvalueである。[rvalueリファレンス](core_lang_spec.md#SS_2_8_2)もlvalueである。

#### rvalue <a id="SS_2_7_1_2"></a>
rvalueとは、

* テンポラリな値を表す式(代入式の右辺値として使われることが多い)
* [xvalue](core_lang_spec.md#SS_2_7_1_3)か[prvalue](core_lang_spec.md#SS_2_7_1_4)である。
* [lvalue](core_lang_spec.md#SS_2_7_1_1)でない[expression](core_lang_spec.md#SS_2_7_1)がrvalueである。

[rvalueリファレンス](core_lang_spec.md#SS_2_8_2)(`T&&`型の変数)はlvalueである。
一方、その初期化に使われる式(例えばstd::move(x))は[xvalue](core_lang_spec.md#SS_2_7_1_3)である。
...
* prvalue(もしくはrvalue)は、
    * アドレス演算子(&)のオペランドになれない。
    * 非constな[lvalueリファレンス](core_lang_spec.md#SS_2_8_1)ではバインドできないが、
      constな[lvalueリファレンス](core_lang_spec.md#SS_2_8_1)や[rvalueリファレンス](core_lang_spec.md#SS_2_8_2)でバインドできる。
  

つまり、prvalueとはいわゆるテンポラリオブジェクトのことである(下記の`std::string{}`で作られるようなオブジェクト)。
多くの場合、prvalueはテンポラリオブジェクトを生成するが、
C++17以降は[RVO(Return Value Optimization)](core_lang_spec.md#SS_2_15_1)により、
...
* [lvalue](core_lang_spec.md#SS_2_7_1_1)か[xvalue](core_lang_spec.md#SS_2_7_1_3)である。
...
* [lvalueリファレンス](core_lang_spec.md#SS_2_8_1)
* [rvalueリファレンス](core_lang_spec.md#SS_2_8_2)
* [forwardingリファレンス](core_lang_spec.md#SS_2_8_3)


これらの概念と関わり強い、[リファレンスcollapsing](core_lang_spec.md#SS_2_8_6)についても併せて解説を行う。
...
* [rvalueリファレンス](core_lang_spec.md#SS_2_8_2)導入前のC++では、すべてのリファレンスはlvalueリファレンスであったため、
  lvalueリファレンスを単にリファレンスと呼んでいた。
* オブジェクトaのエイリアスとして、
   リファレンスa_refが宣言されることを「a_refはaをバインドする」という。
* 以下のコード例で示すように、
    * 非const lvalueリファレンスは[rvalue](core_lang_spec.md#SS_2_7_1_2)をバインドできないが、
    * const lvalueリファレンスは[rvalue](core_lang_spec.md#SS_2_7_1_2)をバインドできる。
...
* 「テンポラリオブジェクト([rvalue](core_lang_spec.md#SS_2_7_1_2))」をバインドできるリファレンス。
* C++11の[moveセマンティクス](cpp_idioms.md#SS_4_5_3)と[perfect forwarding](core_lang_spec.md#SS_2_8_5)を実現するために導入された。
* **注意1** 型が`T&&`である変数の値カテゴリは[lvalue](core_lang_spec.md#SS_2_7_1_1)である。
...
ref_refの型は`int &&`であるが、ref_refの値カテゴリは[rvalue](core_lang_spec.md#SS_2_7_1_2)ではなく、[lvalue](core_lang_spec.md#SS_2_7_1_1)である。
...
この動作を理解することは、
[moveセマンティクス](cpp_idioms.md#SS_4_5_3)や[perfect forwarding](core_lang_spec.md#SS_2_8_5)を正しく実装/使用するために極めて重要である。
...
* [lvalueからの代入](core_lang_spec.md#SS_2_8_2_1)
* [rvalueからの代入](core_lang_spec.md#SS_2_8_2_2)
* [std::move(lvalue)からの代入](core_lang_spec.md#SS_2_8_2_3)



#### lvalueからの代入 <a id="SS_2_8_2_1"></a>
下記コードにより「[lvalue](core_lang_spec.md#SS_2_7_1_1)からの代入」を説明する。
...
([リファレンスcollapsing](core_lang_spec.md#SS_2_8_6)により、このようなバインドが可能になる)。
...
下記のコードは[ジェネリックラムダ](core_lang_spec.md#SS_2_11_6)の引数をforwardingリファレンスにした例である。
...
ユニバーサルリファレンスとは、「[forwardingリファレンス](core_lang_spec.md#SS_2_8_3)」の通称、もしくは旧称である。

### perfect forwarding <a id="SS_2_8_5"></a>
perfect forwarding(完全転送)とは、引数の[rvalue](core_lang_spec.md#SS_2_7_1_2)性や
[lvalue](core_lang_spec.md#SS_2_7_1_1)性を損失することなく、
その引数を別の関数に転送する技術のことを指す。
通常は、[forwardingリファレンス](core_lang_spec.md#SS_2_8_3)である関数の仮引数をstd::forwardを用いて、
他の関数に渡すことで実現される。
...
[rvalue修飾](core_lang_spec.md#SS_2_8_7_1)と[lvalue修飾](core_lang_spec.md#SS_2_8_7_2)とを併せて、リファレンス修飾と呼ぶ。

#### rvalue修飾 <a id="SS_2_8_7_1"></a>
下記GetString0()のような関数が返すオブジェクトの内部メンバに対する[ハンドル](cpp_idioms.md#SS_4_12_8)は、
...
[rvalue修飾](core_lang_spec.md#SS_2_8_7_1)を参照せよ。
...
- [初期化付きfor文(従来のfor文)](core_lang_spec.md#SS_2_9_4_1)
- [初期化付きwhile文(従来のwhile文)](core_lang_spec.md#SS_2_9_4_2)
- [初期化付きif文](core_lang_spec.md#SS_2_9_4_3)
- [初期化付きswitch文](core_lang_spec.md#SS_2_9_4_4)
...
[初期化付きif文](core_lang_spec.md#SS_2_9_4_3)/[初期化付きswitch文](core_lang_spec.md#SS_2_9_4_4)はC++17から導入されたシンタックスであるが、
...
クラスの独自の[<=>演算子](core_lang_spec.md#SS_2_6_4_1)を定義する場合、下記のように使用することができる。
...
* [co_await](core_lang_spec.md#SS_2_10_1_1)
* [co_return](core_lang_spec.md#SS_2_10_1_2)
* [co_yield](core_lang_spec.md#SS_2_10_1_3)
...
co_returnは通常[co_await](core_lang_spec.md#SS_2_10_1_1)と同時に使われることが多い。
...
[co_await](core_lang_spec.md#SS_2_10_1_1)、co_returnの例でみたように、
...
* [constexprラムダ](core_lang_spec.md#SS_2_5_9)とはクロージャ型の[constexprインスタンス](core_lang_spec.md#SS_2_5_6)。
* [ジェネリックラムダ](core_lang_spec.md#SS_2_11_6)とは、C++11のラムダ式を拡張して、
...
「[ラムダ式](core_lang_spec.md#SS_2_10_3)」を参照せよ。
...
「[一時的ラムダ](core_lang_spec.md#SS_2_10_3_3)」を参照せよ。
...
下記に示すように、[Polymorphic Memory Resource(pmr)](stdlib_and_concepts.md#SS_3_7)のpool_resourceの初期化には、
...
「テンプレートのパラメータ置き換えに失敗した([ill-formed](core_lang_spec.md#SS_2_14_1)になった)際に、
即時にコンパイルエラーとはせず、置き換えに失敗したテンプレートを
[name lookup](core_lang_spec.md#SS_2_12_2)の候補から除外する」
という言語機能である。

### メタ関数 <a id="SS_2_11_2"></a>
メタ関数とは、型を引数として型または値を返すテンプレートのことを指す。
通常の関数が実行時に値を返すのに対し、メタ関数はコンパイル時に型情報を生成または変換する。
主要なメタ関数は標準ライブラリの[type_traits](stdlib_and_concepts.md#SS_3_2)で定義されている。

### コンセプト <a id="SS_2_11_3"></a>
C++17までのテンプレートには以下のような問題があった。

* [SFINAE](core_lang_spec.md#SS_2_11_1)による制約が複雑  
  テンプレートの制約を行うために、
...
クラステンプレートの型推論が不十分な場合、[テンプレートの型推論ガイド](core_lang_spec.md#SS_2_11_9)を追加することにより、
型推論を強化することができる。


### テンプレートの型推論ガイド <a id="SS_2_11_9"></a>
[CTAD(Class Template Argument Deduction)](core_lang_spec.md#SS_2_11_8)による型推論をカスタマイズするために、型推論ガイドを定義できる。
...
[CTAD(Class Template Argument Deduction)](core_lang_spec.md#SS_2_11_8)による型推論ができない。
...
このような場合、[SFINAE](core_lang_spec.md#SS_2_11_1)によるオーバーロードが必須であったが、
...
この構文は[パラメータパック](core_lang_spec.md#SS_2_11_4)の展開においても有用な場合がある。
...
可読性と保守性が向上する。
コード例については、[decltype](core_lang_spec.md#SS_2_11_15)を参照せよ。

### decltype <a id="SS_2_11_15"></a>
decltypeはオペランドに[expression](core_lang_spec.md#SS_2_7_1)を取り、その型を算出する機能である。
...
クロージャ型(「[ラムダ式](core_lang_spec.md#SS_2_10_3)」参照)
...
(「[autoパラメータによる関数テンプレートの簡易定義](core_lang_spec.md#SS_2_11_13)」を参照)。
...
C++14から導入された[関数の戻り値型auto](core_lang_spec.md#SS_2_11_18)と似た、
...
このドキュメントでのルックアップとは[name lookup](core_lang_spec.md#SS_2_12_2)を指す。
...
1. ToString()呼び出しの引数xの型Xが名前空間NS_LUで定義されているため、
   ToStringを探索する名前空間にNS_LUを組み入れる(「[関連名前空間](core_lang_spec.md#SS_2_12_6)」参照)
...
2. 1の後、テンプレートパラメータを展開した関数内で、
   [関連名前空間](core_lang_spec.md#SS_2_12_6)の宣言も含めたname lookupを行う。
...
1. TypeName()呼び出しの引数xの型Xが名前空間NS_TPLUで宣言されているため、
   NS_TPLUをTypeNameを探索する[関連名前空間](core_lang_spec.md#SS_2_12_6)にする。
...
3. TypeNameは関数テンプレートであるためtwo phase lookupが以下のように行われる。
    ...
    2. TypeName内でのToType(t)の呼び出しに対しては、2nd name lookupが行われる。
       ...
       tの型がNS_TPLU::Xであるため[関連名前空間](core_lang_spec.md#SS_2_12_6)となったNS_TPLUがname lookupの対象となるが、
       グローバル名前空間内のToTypeは、
       NS_TPLU内でTypeNameより前に宣言されたtemplate<> ToTypeによって[name-hiding](core_lang_spec.md#SS_2_12_9)が起こり、
...
1. NS_TPLUを名前空間と関連付けする
   (引数の型がintなのでNS_TPLUは[関連名前空間](core_lang_spec.md#SS_2_12_6)とならず、NS_TPLUを明示する必要がある)。
2. TypeName()呼び出しより前方で宣言されたNS_TPLUの中からTypeNameを見つける。
3. TypeNameは関数テンプレートであるためtwo phase lookupが以下のように行われる。
    1. TypeName内でのHeader(int{})の呼び出しは、1st name lookupにより、
       前例と同じ理由で、Header(long)の宣言と関連付けられる。
    2. TypeName内でのToType(t)の呼び出しに対しては、2nd name lookupが行われる。
       tの型がintであるためNS_TPLUは[関連名前空間](core_lang_spec.md#SS_2_12_6)とならず、通常のname lookupと同様に
...
サンプルコードを[g++](cpp_idioms.md#SS_4_13_1)と[clang++](cpp_idioms.md#SS_4_13_2)でコンパイルしている)。
...
によるとこの動作は未定義のようだが、
[g++](cpp_idioms.md#SS_4_13_1)/[clang++](cpp_idioms.md#SS_4_13_2)両方ともこのコードを警告なしでコンパイルする)。
...
* TypeNameの中で行われる2nd name lookupの対象となる宣言は下記の和集合である。
    ...
    * TypeName呼び出しより前方にある[関連名前空間](core_lang_spec.md#SS_2_12_6)内の宣言

この認識に基づくNS_TPLU2::Yに対するグローバルなTypeName内でのtwo phase name lookupは、

1. TypeName内に1st name lookupの対象がないため何もしない。
2. TypeName内の2nd name lookupに使用される[関連名前空間](core_lang_spec.md#SS_2_12_6)NS_TPLU2は、
...
このテストはエラーとならなければならないが、[g++](cpp_idioms.md#SS_4_13_1)ではパスしてしまう。
2nd name lookupのロジックにバグがあるようである。

有難いことに、[clang++](cpp_idioms.md#SS_4_13_2)では仕様通りこのテストはエラーとなり、
...
通常はその略語である[ADL](core_lang_spec.md#SS_2_12_5)と呼ばれる。

### ADL <a id="SS_2_12_5"></a>
ADLとは、関数の実引数の型が宣言されている名前空間(これを[関連名前空間](core_lang_spec.md#SS_2_12_6)と呼ぶ)内の宣言が、
その関数の[name lookup](core_lang_spec.md#SS_2_12_2)の対象になることである。
...
すでに述べたようにこれをADLと呼び、この場合のNS_ADLを[関連名前空間](core_lang_spec.md#SS_2_12_6)と呼ぶ。
...
[ADL](core_lang_spec.md#SS_2_12_5)(実引数依存探索)によってname lookupの対象になった宣言を含む名前空間のことである。
...
これにより、意図しない[name lookup](core_lang_spec.md#SS_2_12_2)を回避することができるため、可読性と安全性が向上する。
一方で、[ADL](core_lang_spec.md#SS_2_12_5)が働かなくなるため、フレキシブルな[name lookup](core_lang_spec.md#SS_2_12_2)ができなくなる。
...
* クラスの内部で定義された、
* 名前空間スコープでの通常の[name lookup](core_lang_spec.md#SS_2_12_2)できず、[ADL](core_lang_spec.md#SS_2_12_5)のみでname lookupできる
...
[name lookup](core_lang_spec.md#SS_2_12_2)の対象外になる」現象一般を指す通称である
...
下記のように[using宣言](core_lang_spec.md#SS_2_12_14)を使用することで、
...
修飾の副作用として「[two phase name lookup](core_lang_spec.md#SS_2_12_3)」の例で示したような
[ADL](core_lang_spec.md#SS_2_12_5)を利用した高度な静的ディスパッチが使用できなくなるが、
...
次に示すのは、[仮想継承](core_lang_spec.md#SS_2_12_11)を使用したダイヤモンド継承の例である。
...
(が、[仮想継承](core_lang_spec.md#SS_2_12_11)による別の問題が発生する)。
...
仮想継承は、[ダイヤモンド継承](core_lang_spec.md#SS_2_12_10)の基底クラスのインスタンスを、
...
[ダイヤモンド継承](core_lang_spec.md#SS_2_12_10)での基底クラスのコンストラクタ呼び出しを一度にするために存在する。
...
仮想基底(クラス)とは、[仮想継承](core_lang_spec.md#SS_2_12_11)の基底クラス指す。

### ドミナンス <a id="SS_2_12_13"></a>
[ドミナンス(Dominance、支配性)](https://en.wikipedia.org/wiki/Dominance_(C%2B%2B))とは、
「探索対称の名前が継承の中にも存在するような場合の[name lookup](core_lang_spec.md#SS_2_12_2)の仕様の一部」
を指す慣用句である。

以下に

* [ダイヤモンド継承を含まない場合](core_lang_spec.md#SS_2_12_13_1)
* [ダイヤモンド継承かつそれが仮想継承でない場合](core_lang_spec.md#SS_2_12_13_2)
* [ダイヤモンド継承かつそれが仮想継承である場合](core_lang_spec.md#SS_2_12_13_3)

のドミナンスについてのコードを例示する。

この例で示したように、[ダイヤモンド継承](core_lang_spec.md#SS_2_12_10)を通常の継承で行うか、
[仮想継承](core_lang_spec.md#SS_2_12_11)で行うかでは結果が全く異なるため、注意が必要である。
...
この[name lookup](core_lang_spec.md#SS_2_12_2)については、[name-hiding](core_lang_spec.md#SS_2_12_9)で説明した通りである。
...
これまでと同様にDerived_0のドミナンスによりBase::fは[name-hiding](core_lang_spec.md#SS_2_12_9)されることになる。
この時、Derived_0、Derived_1がBaseから[仮想継承](core_lang_spec.md#SS_2_12_11)した効果により、
この継承ヒエラルキーの中でBaseは１つのみ存在することになるため、
Derived_1により導入されたBase::fも併せて[name-hiding](core_lang_spec.md#SS_2_12_9)される。
...
[using宣言](core_lang_spec.md#SS_2_12_14)よりも危険であり、また、
下記のように[name-hiding](core_lang_spec.md#SS_2_12_9)された識別子の導入には効果がない。
...
C++では、[try-catch](core_lang_spec.md#SS_2_13_1)構文や[エクセプションのthrow](core_lang_spec.md#SS_2_13_3)文使用してエクセプション処理を実現する。
...
エクセプションのtry-catchは[関数tryブロック](core_lang_spec.md#SS_2_13_2)によっても実装できる。

一般にエクセプションオブジェクトのcatchには上記ののコード例のように`T const&`を使用することが好ましい。
これにより、エクセプションオブジェクトの[スライシング](cpp_idioms.md#SS_4_10_3)を避けることができる。
...
throwのオペランドには、慣習的に[std::exception](stdlib_and_concepts.md#SS_3_3_1)の派生クラスのインスタンスを用いることが多い。
...
`throw e;`では、元のエクセプションオブジェクトが[スライシング](cpp_idioms.md#SS_4_10_3)される可能性があるためである。
...
* [no-fail保証](core_lang_spec.md#SS_2_13_7_1)
* [強い安全性の保証](core_lang_spec.md#SS_2_13_7_2)
* [基本的な安全性の保証](core_lang_spec.md#SS_2_13_7_3)

#### no-fail保証 <a id="SS_2_13_7_1"></a>
「no-fail保証」を満たす関数はエクセプションをthrowしない。
no-failを保証する関数は、
[noexcept](core_lang_spec.md#SS_2_13_6)を使用してエクセプションを発生させないことを明示できる。
...
の呼び出しでエクセプションがthrowされると、[未定義動作](core_lang_spec.md#SS_2_14_3)や[未規定動作](core_lang_spec.md#SS_2_14_4)が発生するため、
...
* [well-formed](core_lang_spec.md#SS_2_14_2)(適格)とはプログラムが全ての構文規則・診断対象の意味規則・
  単一定義規則を満たすことである。
* ill-formed(不適格)とはプログラムが適格でないことである。

プログラムがwell-formedになった場合、そのプログラムはコンパイルできる。
プログラムがill-formedになった場合、通常はコンパイルエラーになるが、
対象がテンプレートの場合、事情は少々異なり、[SFINAE](core_lang_spec.md#SS_2_11_1)によりコンパイルできることもある。

### well-formed <a id="SS_2_14_2"></a>
「[ill-formed](core_lang_spec.md#SS_2_14_1)」を参照せよ。
...
| 種類            |定義                                                               | 例                               | 結果                           |
|-----------------|-------------------------------------------------------------------|----------------------------------|--------------------------------|
|[未定義動作](core_lang_spec.md#SS_2_14_3)|C++標準が全く保証しない動作                                        | ゼロ除算、配列範囲外アクセス     | 予測不能(クラッシュなど)       |
|[未規定動作](core_lang_spec.md#SS_2_14_4)|C++標準が動作を定めていないが、いくつかの選択肢が許容されている動作| `int8_t` に収まらない値のキャスト| 実装依存(異なるが合理的な動作) |
...
見た目が類似する[修飾付き関数呼び出し](core_lang_spec.md#SS_2_12_7)とは無関係である。
...
「[ODR](core_lang_spec.md#SS_2_14_10)」を参照せよ。
...
[alignas](core_lang_spec.md#SS_2_14_11_2)、
[alignof](core_lang_spec.md#SS_2_14_11_1)によりコンパイラの標準的な方法でアライメントのコントロールできるようになった。
...
それに対し、C++14までは、演算子のオペランド部分式の評価順序は[未規定動作](core_lang_spec.md#SS_2_14_4)であった。
