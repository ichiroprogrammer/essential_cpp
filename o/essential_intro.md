...
## 改訂履歴 <a id="SS_1_1"></a>
* V20.13
    * 凝集性に関して、正確に記述した。それに合わせてクライテリアを見直した。
    * `_fwd.h`イディオム追加
    * コード・ユニット、ファイルペア、パッケージの概念の定義
    * 「Robert C. Martinのコンポーネント原則」の解説
...
* 特定の規則、法則、慣習等を説明するためのソースコードは、シンプルさを優先するため、
  ...
  [Trailing Underscore(末尾アンダースコア)](cpp_idioms.md#SS_4_11_4)には従っている。
