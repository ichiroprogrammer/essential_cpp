...
#define SUPPRESS_WARN_CLANG_ADDRESS _Pragma("clang diagnostic ignored \"-Wtautological-pointer-compare\"")
...
#define SUPPRESS_WARN_CLANG_MISLEADING_INDENT _Pragma("clang diagnostic ignored \"-Wmisleading-indentation\"")
#define SUPPRESS_WARN_CLANG_DEPRECATED _Pragma("clang diagnostic ignored \"-Wdeprecated\"")
#define SUPPRESS_WARN_CLANG_DEPRECATED_COPY _Pragma("clang diagnostic ignored \"-Wdeprecated-copy\"")
#define SUPPRESS_WARN_CLANG_DEPRECATED_DECL _Pragma("clang diagnostic ignored \"-Wdeprecated-declarations\"")
...
#define SUPPRESS_WARN_CLANG_INACCESSIBLE_BASE _Pragma("clang diagnostic ignored \"-Winaccessible-base\"")
#define SUPPRESS_WARN_CLANG_INIT_OVERRIDE _Pragma("clang diagnostic ignored \"-Winitializer-overrides\"")
#define SUPPRESS_WARN_CLANG_MISSING_BRACES _Pragma("clang diagnostic ignored \"-Wmissing-braces\"")
#define SUPPRESS_WARN_CLANG_MISSING_FIELD_INIT _Pragma("clang diagnostic ignored \"-Wmissing-field-initializers\"")
#define SUPPRESS_WARN_CLANG_NON_VIRTUAL_DTOR _Pragma("clang diagnostic ignored \"-Wnon-virtual-dtor\"")
...
#define SUPPRESS_WARN_CLANG_PESSIMIZING_MOVE _Pragma("clang diagnostic ignored \"-Wpessimizing-move\"")
#define SUPPRESS_WARN_CLANG_SHIFT_COUNT_OVERFLOW _Pragma("clang diagnostic ignored \"-Wshift-count-overflow\"")
#define SUPPRESS_WARN_CLANG_SIGN_COMPARE _Pragma("clang diagnostic ignored \"-Wsign-compare\"")
#define SUPPRESS_WARN_CLANG_SIZEOF_ARRAY_ARG _Pragma("clang diagnostic ignored \"-Wsizeof-array-argument\"")
#define SUPPRESS_WARN_CLANG_SIZEOF_POINTER_DIV _Pragma("clang diagnostic ignored \"-Wsizeof-pointer-div\"")
...
#define SUPPRESS_WARN_CLANG_UNUSED_LOCAL_TYPEDEF _Pragma("clang diagnostic ignored \"-Wunused-local-typedefs\"")
...
#define SUPPRESS_WARN_CLANG_USER_DEFINED_LITERAL _Pragma("clang diagnostic ignored \"-Wuser-defined-literals\"")
...
#define SUPPRESS_WARN_CLANG_CONVERSION_VEXING_PARSE _Pragma("clang diagnostic ignored \"-Wvexing-parse\"")

#define SUPPRESS_WARN_CLANG_ENUM_COMP _Pragma("clang diagnostic ignored \"-Wenum-compare\"")
#define SUPPRESS_WARN_CLANG_ENUM_ENUM_COMP_SWITCH _Pragma("clang diagnostic ignored \"-Wenum-compare-switch\"")
#define SUPPRESS_WARN_CLANG_UNUSED_BUT_SET_VAR _Pragma("clang diagnostic ignored \"-Wunused-but-set-variable\"")
#define SUPPRESS_WARN_CLANG_WRITE_STR _Pragma("clang diagnostic ignored \"-Wwritable-strings\"")
...
#define SUPPRESS_WARN_CLANG_LITERAL_CONVERSION _Pragma("clang diagnostic ignored \"-Wliteral-conversion\"")
#define SUPPRESS_WARN_CLANG_LOGICAL_OP_PARENTHESES _Pragma("clang diagnostic ignored \"-Wlogical-op-parentheses\"")
#define SUPPRESS_WARN_CLANG_MISMATCHED_NEW_DELETE _Pragma("clang diagnostic ignored \"-Wmismatched-new-delete\"")
#define SUPPRESS_WARN_CLANG_NARROWING _Pragma("clang diagnostic ignored \"-Wc++11-narrowing\"")
#define SUPPRESS_WARN_CLANG_NON_POD_VARARGS _Pragma("clang diagnostic ignored \"-Wnon-pod-varargs\"")
#define SUPPRESS_WARN_CLANG_OVERLOADED_VIRTUAL _Pragma("clang diagnostic ignored \"-Woverloaded-virtual\"")
#define SUPPRESS_WARN_CLANG_POINTER_BOOL_CONVERSION _Pragma("clang diagnostic ignored \"-Wpointer-bool-conversion\"")
...
#define SUPPRESS_WARN_CLANG_REINTERPRET_BASE_CLASS _Pragma("clang diagnostic ignored \"-Wreinterpret-base-class\"")
...
#define SUPPRESS_WARN_CLANG_RETURN_STACK_ADDRESS _Pragma("clang diagnostic ignored \"-Wreturn-stack-address\"")
...
#define SUPPRESS_WARN_CLANG_UNDEFINED_INTERNAL _Pragma("clang diagnostic ignored \"-Wundefined-internal\"")
#define SUPPRESS_WARN_CLANG_UNDEF_COMP _Pragma("clang diagnostic ignored \"-Wtautological-undefined-compare\"")
#define SUPPRESS_WARN_CLANG_OVERLAP_COMP _Pragma("clang diagnostic ignored \"-Wtautological-overlap-compare\"")
#define SUPPRESS_WARN_CLANG_INT_FLOAT_CONVERSION \
    _Pragma("clang diagnostic ignored \"-Wimplicit-const-int-float-conversion\"")

#define SUPPRESS_WARN_CLANG_UNEVALUATED_EXPRESSION _Pragma("clang diagnostic ignored \"-Wunevaluated-expression\"")
...
#define SUPPRESS_WARN_CLANG_UNUSED_CONST_VAR _Pragma("clang diagnostic ignored \"-Wunused-const-variable\"")
#define SUPPRESS_WARN_CLANG_UNUSED_INTERNAL_DECL _Pragma("clang diagnostic ignored \"-Wunneeded-internal-declaration\"")
#define SUPPRESS_WARN_CLANG_UNUSED_PRIVATE_FIELD _Pragma("clang diagnostic ignored \"-Wunused-private-field\"")
#define SUPPRESS_WARN_CLANG_UNUSED_CAPTURE _Pragma("clang diagnostic ignored \"-Wunused-lambda-capture\"")
#define SUPPRESS_WARN_CLANG_ENUM_COMP_SWITCH _Pragma("clang diagnostic ignored \"-Wenum-compare-switch\"")
...
#define SUPPRESS_WARN_CLANG_WRITE_STR
