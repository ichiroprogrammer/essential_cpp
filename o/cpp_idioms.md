...
&emsp;&emsp; [イディオム](cpp_idioms.md#SS_4_1)  
&emsp;&emsp;&emsp; [ガード節(Early Return)](cpp_idioms.md#SS_4_1_1)  
&emsp;&emsp;&emsp; [RAII(scoped guard)](cpp_idioms.md#SS_4_1_2)  
&emsp;&emsp;&emsp; [Copy-And-Swap](cpp_idioms.md#SS_4_1_3)  
&emsp;&emsp;&emsp; [CRTP(curiously recurring template pattern)](cpp_idioms.md#SS_4_1_4)  
&emsp;&emsp;&emsp; [Accessor](cpp_idioms.md#SS_4_1_5)  
&emsp;&emsp;&emsp; [Immutable](cpp_idioms.md#SS_4_1_6)  
&emsp;&emsp;&emsp; [NVI(non virtual interface)](cpp_idioms.md#SS_4_1_7)  

&emsp;&emsp; [実装パターン](cpp_idioms.md#SS_4_2)  
&emsp;&emsp;&emsp; [Pimpl](cpp_idioms.md#SS_4_2_1)  
&emsp;&emsp;&emsp; [lightweight Pimpl](cpp_idioms.md#SS_4_2_2)  
&emsp;&emsp;&emsp; [BitmaskType](cpp_idioms.md#SS_4_2_3)  
&emsp;&emsp;&emsp; [Future](cpp_idioms.md#SS_4_2_4)  
&emsp;&emsp;&emsp; [Null Object](cpp_idioms.md#SS_4_2_5)  
&emsp;&emsp;&emsp; [Cでのクラス表現](cpp_idioms.md#SS_4_2_6)  

&emsp;&emsp; [オブジェクト指向](cpp_idioms.md#SS_4_3)  
&emsp;&emsp;&emsp; [is-a](cpp_idioms.md#SS_4_3_1)  
&emsp;&emsp;&emsp; [has-a](cpp_idioms.md#SS_4_3_2)  
&emsp;&emsp;&emsp; [is-implemented-in-terms-of](cpp_idioms.md#SS_4_3_3)  
&emsp;&emsp;&emsp;&emsp; [public継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_4_3_3_1)  
&emsp;&emsp;&emsp;&emsp; [private継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_4_3_3_2)  
&emsp;&emsp;&emsp;&emsp; [コンポジションによる(has-a)is-implemented-in-terms-of](cpp_idioms.md#SS_4_3_3_3)  

&emsp;&emsp; [オブジェクトの所有権](cpp_idioms.md#SS_4_4)  
&emsp;&emsp;&emsp; [オブジェクトの排他所有](cpp_idioms.md#SS_4_4_1)  
&emsp;&emsp;&emsp; [オブジェクトの共有所有](cpp_idioms.md#SS_4_4_2)  
&emsp;&emsp;&emsp; [オブジェクトの循環所有](cpp_idioms.md#SS_4_4_3)  

&emsp;&emsp; [copy/moveと等価性のセマンティクス](cpp_idioms.md#SS_4_5)  
&emsp;&emsp;&emsp; [等価性のセマンティクス](cpp_idioms.md#SS_4_5_1)  
&emsp;&emsp;&emsp; [copyセマンティクス](cpp_idioms.md#SS_4_5_2)  
&emsp;&emsp;&emsp; [moveセマンティクス](cpp_idioms.md#SS_4_5_3)  
&emsp;&emsp;&emsp; [MoveAssignable要件](cpp_idioms.md#SS_4_5_4)  
&emsp;&emsp;&emsp; [CopyAssignable要件](cpp_idioms.md#SS_4_5_5)  

&emsp;&emsp; [関数設計のガイドライン](cpp_idioms.md#SS_4_6)  
&emsp;&emsp;&emsp; [関数の引数と戻り値の型](cpp_idioms.md#SS_4_6_1)  
&emsp;&emsp;&emsp; [サイクロマティック複雑
&emsp;&emsp;&emsp; [ミックスイン](cpp_idioms.md#SS_4_12_7)  
&emsp;&emsp;&emsp; [ハンドル](cpp_idioms.md#SS_4_12_8)  
&emsp;&emsp;&emsp; [フリースタンディング環境](cpp_idioms.md#SS_4_12_9)  
&emsp;&emsp;&emsp; [メモリ保護機構](cpp_idioms.md#SS_4_12_10)  
&emsp;&emsp;&emsp; [CPU例外](cpp_idioms.md#SS_4_12_11)  
&emsp;&emsp;&emsp; [Fluent Interface](cpp_idioms.md#SS_4_12_12)  
&emsp;&emsp;&emsp; [サイクロマティック複雑度](cpp_idioms.md#SS_4_12_13)  
&emsp;&emsp;&emsp; [凝集性](cpp_idioms.md#SS_4_12_14)  
&emsp;&emsp;&emsp;&emsp; [凝集性の欠如](cpp_idioms.md#SS_4_12_14_1)  
&emsp;&emsp;&emsp;&emsp; [LCOM](cpp_idioms.md#SS_4_12_14_2)  
&emsp;&emsp;&emsp;&emsp; [PercentLackOfCohesion](cpp_idioms.md#SS_4_12_14_3)  

&emsp;&emsp;&emsp; [Spurious Wakeup](cpp_idioms.md#SS_4_12_15)  
&emsp;&emsp;&emsp; [副作用](cpp_idioms.md#SS_4_12_16)  
&emsp;&emsp;&emsp; [Itanium C++ ABI](cpp_idioms.md#SS_4_12_17)  

&emsp;&emsp; [C++コンパイラ](cpp_idioms.md#SS_4_13)  
&emsp;&emsp;&emsp; [g++](cpp_idioms.md#SS_4_13_1)  
&emsp;&emsp;&emsp; [clang++](cpp_idioms.md#SS_4_13_2)  

&emsp;&emsp; [非ソフトウェア用語](cpp_idioms.md#SS_4_14)  
&emsp;&emsp;&emsp; [セマンティクス](cpp_idioms.md#SS_4_14_1)  
&emsp;&emsp;&emsp; [割れ窓理論](cpp_idioms.md#SS_4_14_2)  
&emsp;&emsp;&emsp; [車輪の再発明](cpp_idioms.md#SS_4_14_3)  
...
以下にこのパターンを使用した[ミックスイン](cpp_idioms.md#SS_4_12_7)の例を示す。
...
* 下記のようなコードはstd::shared_ptrの仕様が想定する[セマンティクス](cpp_idioms.md#SS_4_14_1)に沿っておらず、
...
X、Yオブジェクトへの[ハンドル](cpp_idioms.md#SS_4_12_8)を完全に失った状態であり、X、Yオブジェクトを解放する手段はない。
...
原因は、copy代入で[スライシング](cpp_idioms.md#SS_4_10_3)が起こるためである。
...
関数構造の適・不適については、[サイクロマティック複雑度](cpp_idioms.md#SS_4_12_13)によって下記テーブルのように定義する。
...
自動生成されるメンバ関数では、
複雑なリソース管理の要件を満たせないことがある(「[シャローコピー](cpp_idioms.md#SS_4_10_1)」参照)。
...
クラス構造の適・不適については、[PercentLackOfCohesion](cpp_idioms.md#SS_4_12_14_3)によって下記テーブルのように定義することができる。
...
このドキュメントでは、以下の方針に基づいて[Modern CMake project layout](cpp_idioms.md#SS_4_8)の構成をカスタマイズすることを推奨する。
...
このスタイルは、C言語由来の「`const`を左に置く」スタイル([west-const](cpp_idioms.md#SS_4_9_3))に比べ、
...
### Trailing Underscore(末尾アンダースコア) <a id="SS_4_9_4"></a>
...
### ケース記法 <a id="SS_4_9_5"></a>
C++の識別子の命名規則(Naming convention)を以下のようにリストアップする。

* [スネークケース(snake_case)](cpp_idioms.md#SS_4_9_5_1)
* [アッパースネークケース(UPPER_SNAKE_CASE)](cpp_idioms.md#SS_4_9_5_2)
* [アッパーキャメルケース(UpperCamelCase)](cpp_idioms.md#SS_4_9_5_3)
* [ロワーキャメルケース(lowerCamelCase)](cpp_idioms.md#SS_4_9_5_4)
* [ケバブケース(kebab-case)](cpp_idioms.md#SS_4_9_5_5)

#### スネークケース(snake_case) <a id="SS_4_9_5_1"></a>
...
#### アッパースネークケース(UPPER_SNAKE_CASE) <a id="SS_4_9_5_2"></a>
...
#### アッパーキャメルケース(UpperCamelCase) <a id="SS_4_9_5_3"></a>
...
#### ロワーキャメルケース(lowerCamelCase) <a id="SS_4_9_5_4"></a>
...
#### ケバブケース(kebab-case) <a id="SS_4_9_5_5"></a>
...
copy代入演算子が行うコピーであり、[ディープコピー](cpp_idioms.md#SS_4_10_2)と対比的に使われる概念である。
...
ディープコピーとは、[シャローコピー](cpp_idioms.md#SS_4_10_1)が発生させる問題を回避したコピーである。
...
danglingポインタとは、[danglingリファレンス](cpp_idioms.md#SS_4_11_2)と同じような状態になったポインタを指す。
...
### Static Initialization Order Fiasco(静的初期化順序問題) <a id="SS_4_11_5"></a>
静的初期化順序問題とは、
...
### Unbounded Functions <a id="SS_4_11_6"></a>
...
### プライオリティインバージョン <a id="SS_4_12_2"></a>
...
### ハンドル <a id="SS_4_12_8"></a>
CやC++の文脈でのハンドルとは、ポインタかリファレンスを指す。

---

### フリースタンディング環境 <a id="SS_4_12_9"></a>
...
- メモリ保護違反例外:
    [メモリ保護機構](cpp_idioms.md#SS_4_12_10)の設定に反した命令を実行した場合に発生する。例えば、リードオンリー領域への書き込み、
...
### Fluent Interface <a id="SS_4_12_12"></a>
...
### サイクロマティック複雑度 <a id="SS_4_12_13"></a>
[サイクロマティック複雑度](https://ja.wikipedia.org/wiki/%E5%BE%AA%E7%92%B0%E7%9A%84%E8%A4%87%E9%9B%91%E5%BA%A6)
とは関数の複雑さを表すメトリクスである。

---

### 凝集性 <a id="SS_4_12_14"></a>
[凝集性(凝集度)](https://ja.wikipedia.org/wiki/%E5%87%9D%E9%9B%86%E5%BA%A6)
とはクラス設計の妥当性を表す尺度の一種であり、「[PercentLackOfCohesion](cpp_idioms.md#SS_4_12_14_3)」というメトリクスで計測される。

* [凝集性の欠如](cpp_idioms.md#SS_4_12_14_1)メトリクスの値が100に近ければ凝集性は低く、この値が0に近ければ凝集性は高い。
...
* 「[Accessor](cpp_idioms.md#SS_4_1_5)」を多用すれば、振る舞いが分散しがちになるため、通常、凝集性は低くなる。
   ...
   より小さいクラスに分割できる。
   なお、以下のクラスでは、実際に計測すると、[PercentLackOfCohesion](cpp_idioms.md#SS_4_12_14_3)が100に近い値となっている。
...
#### 凝集性の欠如 <a id="SS_4_12_14_1"></a>
[凝集性の欠如](cpp_idioms.md#SS_4_12_14_1)とはLack of Cohesion in Methodsの和訳であり、[LCOM](cpp_idioms.md#SS_4_12_14_2)と呼ばれる。

LCOMはメソッドペアの数に基づく非正規化の整数値であるため、
メソッド数が多いクラスほど値が大きくなりやすく、クラス間で単純に値の大小を比較することはできない。
この弱点を補う指標として実務上広く用いられるのが、[PercentLackOfCohesion](cpp_idioms.md#SS_4_12_14_3)である。
...
#### PercentLackOfCohesion <a id="SS_4_12_14_3"></a>
厳密性を欠くが、クラスの凝集性を測定するためには、
テクマトリックス社製のUnderstandのメトリクスPercentLackOfCohesionを使用するのが実践的である。

PercentLackOfCohesionは、[LCOM](cpp_idioms.md#SS_4_12_14_2)と同様に使用できるメトリクスであり、0〜100に正規化された値である。

[クラス凝集性のクライテリア](cpp_idioms.md#SS_4_7_3)に示した通り、構造的欠陥をを持つクラスの自動的な抽出に有用である。

---

### Spurious Wakeup <a id="SS_4_12_15"></a>
...
### Itanium C++ ABI <a id="SS_4_12_17"></a>
...
[g++](cpp_idioms.md#SS_4_13_1)や[clang++](cpp_idioms.md#SS_4_13_2)はx86/x86-64やARM64など多くのプラットフォームでもItaniumC++ABI準拠の規約を採用している。
