...
#define SUPPRESS_WARN_GCC_DEPRECATED_DECL _Pragma("GCC diagnostic ignored \"-Wdeprecated-declarations\"")
...
#define SUPPRESS_WARN_GCC_INACCESSIBLE_BASE _Pragma("GCC diagnostic ignored \"-Winaccessible-base\"")
#define SUPPRESS_WARN_GCC_MISLEADING_INDENT _Pragma("GCC diagnostic ignored \"-Wmisleading-indentation\"")
...
#define SUPPRESS_WARN_GCC_SHIFT_COUNT_OVERFLOW _Pragma("GCC diagnostic ignored \"-Wshift-count-overflow\"")
#define SUPPRESS_WARN_GCC_SIGN_COMPARE _Pragma("GCC diagnostic ignored \"-Wsign-compare\"")
#define SUPPRESS_WARN_GCC_SIZEOF_ARRAY_ARG _Pragma("GCC diagnostic ignored \"-Wsizeof-array-argument\"")
#define SUPPRESS_WARN_GCC_SIZEOF_POINTER_DIV _Pragma("GCC diagnostic ignored \"-Wsizeof-pointer-div\"")
...
#define SUPPRESS_WARN_GCC_UNUSED_LOCAL_TYPEDEF _Pragma("GCC diagnostic ignored \"-Wunused-local-typedefs\"")
...
#define SUPPRESS_WARN_GCC_USER_DEFINED_LITERAL _Pragma("GCC diagnostic ignored \"-Wliteral-suffix\"")
...
#define SUPPRESS_WARN_GCC_CONVERSION_VEXING_PARSE _Pragma("GCC diagnostic ignored \"-Wvexing-parse\"")
...
#define SUPPRESS_WARN_GCC_UNUSED_BUT_SET_VAR _Pragma("GCC diagnostic ignored \"-Wunused-but-set-variable\"")
...
#define SUPPRESS_WARN_GCC_MISSING_FIELD_INIT _Pragma("GCC diagnostic ignored \"-Wmissing-field-initializers\"")
