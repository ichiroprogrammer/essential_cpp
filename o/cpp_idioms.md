...
クラス構造の適・不適については、[LCOM](cpp_idioms.md#SS_4_12_14_2)によって下記テーブルのように定義する。
...
「[凝集性の欠如](cpp_idioms.md#SS_4_12_14_1)(LCOM)」というメトリクスで計測される。

* [凝集性の欠如](cpp_idioms.md#SS_4_12_14_1)メトリクスの値が1に近ければ凝集性は低く、この値が0に近ければ凝集性は高い。
...
[凝集性](cpp_idioms.md#SS_4_12_14)の欠如(Lack of Cohesion in Methods/LCOM)とは、
...
クラスデザイン見直しの基準値としてLCOMを活用する場合、[クラス凝集性のクライテリア](cpp_idioms.md#SS_4_7_3)に具体的な推奨値を示す。

#### LCOM <a id="SS_4_12_14_2"></a>
[凝集性の欠如](cpp_idioms.md#SS_4_12_14_1)とはLack of Cohesion in Methodsの和訳であり、LCOMと呼ばれる。
