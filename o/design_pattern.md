...
&emsp;&emsp; [ガード節](design_pattern.md#SS_6_1)  
&emsp;&emsp; [BitmaskType](design_pattern.md#SS_6_2)  
&emsp;&emsp; [Pimpl](design_pattern.md#SS_6_3)  
&emsp;&emsp; [lightweight Pimpl](design_pattern.md#SS_6_4)  
&emsp;&emsp; [Accessor](design_pattern.md#SS_6_5)  
&emsp;&emsp; [Copy-And-Swap](design_pattern.md#SS_6_6)  
&emsp;&emsp; [Immutable](design_pattern.md#SS_6_7)  
&emsp;&emsp; [Clone(仮想コンストラクタ)](design_pattern.md#SS_6_8)  
&emsp;&emsp; [NVI(non virtual interface)](design_pattern.md#SS_6_9)  
&emsp;&emsp; [RAII(scoped guard)](design_pattern.md#SS_6_10)  
&emsp;&emsp; [Future](design_pattern.md#SS_6_11)  
&emsp;&emsp; [DI(dependency injection)](design_pattern.md#SS_6_12)  
&emsp;&emsp; [Singleton](design_pattern.md#SS_6_13)  
&emsp;&emsp; [State](design_pattern.md#SS_6_14)  
&emsp;&emsp; [Null Object](design_pattern.md#SS_6_15)  
&emsp;&emsp; [Templateメソッド](design_pattern.md#SS_6_16)  
&emsp;&emsp; [Factory](design_pattern.md#SS_6_17)  
&emsp;&emsp; [Named Constructor](design_pattern.md#SS_6_18)  
&emsp;&emsp; [Proxy](design_pattern.md#SS_6_19)  
&emsp;&emsp; [Strategy](design_pattern.md#SS_6_20)  
&emsp;&emsp; [Visitor](design_pattern.md#SS_6_21)  
&emsp;&emsp; [CRTP(curiously recurring template pattern)](design_pattern.md#SS_6_22)  
&emsp;&emsp; [Observer](design_pattern.md#SS_6_23)  
&emsp;&emsp; [MVC](design_pattern.md#SS_6_24)  
&emsp;&emsp; [Cでのクラス表現](design_pattern.md#SS_6_25)  
...
## lightweight Pimpl <a id="SS_6_4"></a>
[Pimpl](design_pattern.md#SS_6_3)の解説で示したように依存関係をシンプルに保つには極めて有効なパターンではあるが、
...
一方で、「[Accessor](design_pattern.md#SS_6_5)」で紹介したsetterは、クラスのimmutabilityを下げる。
...
## Clone(仮想コンストラクタ) <a id="SS_6_8"></a>
オブジェクトコピーによる[スライシング](cpp_idioms.md#SS_4_7_3)を回避するためのイデオムである。
...
## NVI(non virtual interface) <a id="SS_6_9"></a>
...
## RAII(scoped guard) <a id="SS_6_10"></a>
...
## DI(dependency injection) <a id="SS_6_12"></a>
メンバ関数内でクラスDependedのオブジェクトを直接、生成する
(もしくは[Singleton](design_pattern.md#SS_6_13)オブジェクトや静的オブジェクト(std::coutやstd::cin等)に直接アクセスする)
クラスNotDIがあるとする。
...
この性質は、[Factory](design_pattern.md#SS_6_17)や[Named Constructor](design_pattern.md#SS_6_18)の実装には不可欠であるが、
...
DI(「[DI(dependency injection)](design_pattern.md#SS_6_12)」参照)と組み合わせて使われることが多い。

「[Templateメソッド](design_pattern.md#SS_6_16)」の例にFactoryを適用したソースコードを下記する。
...
## Named Constructor <a id="SS_6_18"></a>
Named Connstructorは、[Singleton](design_pattern.md#SS_6_13)のようなオブジェクトを複数、生成するためのパターンである。
...
次に示したのは「[Factory](design_pattern.md#SS_6_17)」の例にこのパターンを適応したコードである。
...
その属性の追加に対して「[オープン・クローズドの原則(OCP)](solid.md#SS_5_2)」に対応した構造となった。
...
あるいは、[DI(dependency injection)](design_pattern.md#SS_6_12)と組み合わせて、下記のような改善も有用である。
...
これを改めるためには、「[CRTP(curiously recurring template pattern)](design_pattern.md#SS_6_22)」が必要になる。

次に示すソースコードはVisitorとは関係がないが、
FileEntityVisitorから派生するクラスを下記クラス図が示すように改善することで、
単体テストが容易になる例である(「[DI(dependency injection)](design_pattern.md#SS_6_12)」参照)。
...
## CRTP(curiously recurring template pattern) <a id="SS_6_22"></a>
CRTPとは、
...
このパターンを用いて、「[Visitor](design_pattern.md#SS_6_21)」のFileEntityの3つの派生クラスが持つコードクローン
...
GUIアプリケーションを[MVC](design_pattern.md#SS_6_24)で実装する場合のModelがSubjectであり、
ViewがObserverNである。
...
ViewはModelの[Observer](design_pattern.md#SS_6_23)であるため、ModelはViewへ依存しない。
