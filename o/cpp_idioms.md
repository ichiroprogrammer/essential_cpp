...
&emsp;[RAII(scoped guard)](cpp_idioms.md#SS_4_1_2)  
&emsp;[Copy-And-Swap](cpp_idioms.md#SS_4_1_3)  
&emsp;[CRTP(curiously recurring template pattern)](cpp_idioms.md#SS_4_1_4)  
&emsp;[Accessor](cpp_idioms.md#SS_4_1_5)  
&emsp;[Immutable](cpp_idioms.md#SS_4_1_6)  
&emsp;[NVI(non virtual interface)](cpp_idioms.md#SS_4_1_7)  
...
&emsp;[REP(リリース等価の原則)](cpp_idioms.md#SS_4_8_1)  
&emsp;[CCP(共通閉鎖の原則)](cpp_idioms.md#SS_4_8_2)  
&emsp;[CRP(共通再利用の原則)](cpp_idioms.md#SS_4_8_3)  
&emsp;[ADP(非循環依存の原則)](cpp_idioms.md#SS_4_8_4)  
...
一方で、「[Accessor](cpp_idioms.md#SS_4_1_5)」で紹介したsetterは、クラスのimmutabilityを下げる。
...
リソース管理を専門とするクラス
(例: 標準ライブラリの[RAII(scoped guard)](cpp_idioms.md#SS_4_1_2)クラス)に任せる設計ガイドラインを指す。
...
それと一体で判断すべき依存構造の原則 [ADP(非循環依存の原則)](cpp_idioms.md#SS_4_8_4)を用いる。

| 原則                           | 一文での定義                             | 視点   | 力の向き／作用   |
|:------------------------------ |:-----------------------------------------|:-------|:-----------------|
| [REP(リリース等価の原則)](cpp_idioms.md#SS_4_8_1) | リリースノートが一本の筋として書けるか   | 提供側 | 凝集（まとめる） |
| [CCP(共通閉鎖の原則)](cpp_idioms.md#SS_4_8_2)     | 変更される理由が一つか                   | 提供側 | 凝集（まとめる） |
| [CRP(共通再利用の原則)](cpp_idioms.md#SS_4_8_3)   | 利用者に不要な依存まで抱えさせていないか | 利用側 | 分割（割る）     |
 
### REP(リリース等価の原則) <a id="SS_4_8_1"></a>
...
CCPは、[REP(リリース等価の原則)](cpp_idioms.md#SS_4_8_1)と同様に「パッケージをまとめることの根拠」になり得る。

### CRP(共通再利用の原則) <a id="SS_4_8_3"></a>
...
[REP(リリース等価の原則)](cpp_idioms.md#SS_4_8_1)/[CCP(共通閉鎖の原則)](cpp_idioms.md#SS_4_8_2)とは逆に、「パッケージを分割することの根拠」になり得る。


### ADP(非循環依存の原則) <a id="SS_4_8_4"></a>
...
- パッケージのソースコードツリーは、[Modern CMake project layout](cpp_idioms.md#SS_4_10)でなければならない。
...
- ライブラリ粒度の凝集性は、関数レベル/クラスの古典的凝集度分類ではなく、[Robert C. Martinのコンポーネント原則](cpp_idioms.md#SS_4_8)
  ...
  中核は次の三原則のパワーバランスである。
    - [REP(リリース等価の原則)](cpp_idioms.md#SS_4_8_1)
    - [CCP(共通閉鎖の原則)](cpp_idioms.md#SS_4_8_2)
    - [CRP(共通再利用の原則)](cpp_idioms.md#SS_4_8_3)
...
C++では[CRTP(curiously recurring template pattern)](cpp_idioms.md#SS_4_1_4)や通常の継承によってミックスインを実現する。
...
* 「[Accessor](cpp_idioms.md#SS_4_1_5)」を多用すれば、振る舞いが分散しがちになるため、通常、凝集性は低くなる。
...
(ただし、「[Immutable](cpp_idioms.md#SS_4_1_6)」の観点からは、QuadraticEquation::Set()がない方が良い)。
