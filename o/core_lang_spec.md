...
&emsp;&emsp;&emsp; [constexpr定数](core_lang_spec.md#SS_2_5_2)  
...
constexpr定数がif文のオカレンスになる場合、[constexpr if文](core_lang_spec.md#SS_2_11_12)することで、
...
このドキュメントでは慣用的に[constexpr定数](core_lang_spec.md#SS_2_5_2)と呼んでいる概念が、コア定数式である。
...
[constexpr定数](core_lang_spec.md#SS_2_5_2)を引数にして、[リテラル型](core_lang_spec.md#SS_2_5_5)のconstexprコンストラクタを呼び出せば、
...
これにより、[Static Initialization Order Fiasco(静的初期化順序問題)](cpp_idioms.md#SS_4_12_12)を回避できる。
...
下記GetString0()のような関数が返すオブジェクトの内部メンバに対する[ハンドル](cpp_idioms.md#SS_4_12_7)は、
