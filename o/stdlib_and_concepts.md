...
[クリティカルセクション](cpp_idioms.md#SS_4_9_2)と呼ぶ)が、std::mutexによりこの問題を回避している。
...
一般に条件変数には、[Spurious Wakeup](cpp_idioms.md#SS_4_9_8)という問題があり、std::condition_variableも同様である。

上記の抜粋である下記のコード例では[Spurious Wakeup](cpp_idioms.md#SS_4_9_8)の対策が行われていないため、
意図通り動作しない可能性がある。
