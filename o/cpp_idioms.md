...
[イディオム](cpp_idioms.md#SS_4_1)  
&emsp;[ガード節(Early Return)](cpp_idioms.md#SS_4_1_1)  
&emsp;[前方宣言ヘッダ(`_fwd.h`)](cpp_idioms.md#SS_4_1_2)  
&emsp;[RAII(scoped guard)](cpp_idioms.md#SS_4_1_3)  
&emsp;[Copy-And-Swap](cpp_idioms.md#SS_4_1_4)  
&emsp;[CRTP(curiously recurring template pattern)](cpp_idioms.md#SS_4_1_5)  
&emsp;[Accessor](cpp_idioms.md#SS_4_1_6)  
&emsp;[Immutable](cpp_idioms.md#SS_4_1_7)  
&emsp;[NVI(non virtual interface)](cpp_idioms.md#SS_4_1_8)  

[実装パターン](cpp_idioms.md#SS_4_2)  
&emsp;[Pimpl](cpp_idioms.md#SS_4_2_1)  
&emsp;[lightweight Pimpl](cpp_idioms.md#SS_4_2_2)  
&emsp;[BitmaskType](cpp_idioms.md#SS_4_2_3)  
&emsp;[Future](cpp_idioms.md#SS_4_2_4)  
&emsp;[Null Object](cpp_idioms.md#SS_4_2_5)  
&emsp;[Cでのクラス表現](cpp_idioms.md#SS_4_2_6)  

[オブジェクト指向](cpp_idioms.md#SS_4_3)  
&emsp;[is-a](cpp_idioms.md#SS_4_3_1)  
&emsp;[has-a](cpp_idioms.md#SS_4_3_2)  
&emsp;[is-implemented-in-terms-of](cpp_idioms.md#SS_4_3_3)  
&emsp;&emsp;[public継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_4_3_3_1)  
&emsp;&emsp;[private継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_4_3_3_2)  
&emsp;&emsp;[コンポジションによる(has-a)is-implemented-in-terms-of](cpp_idioms.md#SS_4_3_3_3)  

[オブジェクトの所有権](cpp_idioms.md#SS_4_4)  
&emsp;[オブジェクトの排他所有](cpp_idioms.md#SS_4_4_1)  
&emsp;[オブジェクトの共有所有](cpp_idioms.md#SS_4_4_2)  
&emsp;[オブジェクトの循環所有](cpp_idioms.md#SS_4_4_3)  

[copy/moveと等価性のセマンティクス](cpp_idioms.md#SS_4_5)  
&emsp;[等価性のセマンティクス](cpp_idioms.md#SS_4_5_1)  
&emsp;[copyセマンティクス](cpp_idioms.md#SS_4_5_2)  
&emsp;[moveセマンティクス](cpp_idioms.md#SS_4_5_3)  
&emsp;[MoveAssignable要件](cpp_idioms.md#SS_4_5_4)  
&emsp;[CopyAssignable要件](cpp_idioms.md#SS_4_5_5)  

[関数設計のガイドライン](cpp_idioms.md#SS_4_6)  
&emsp;[関数の引数と戻り値の型](cpp_idioms.md#SS_4_6_1)  
&emsp;[サイクロマティック複雑度のクライテリア](cpp_idioms.md#SS_4_6_2)  
&emsp;[関数の行数のクライテリア](cpp_idioms.md#SS_4_6_3)  

[クラス設計のガイドライン](cpp_idioms.md#SS_4_7)  
&emsp;[ゼロの原則(Rule of Zero)](cpp_idioms.md#SS_4_7_1)  
&emsp;[五の原則(Rule of Five)](cpp_idioms.md#SS_4_7_2)  
&emsp;[クラス凝集性のクライテリア](cpp_idioms.md#SS_4_7_3)  

[Robert C. Martinのコンポーネント原則](cpp_idioms.md#SS_4_8)  
&emsp;[リリース等価の原則(REP)](cpp_idioms.md#SS_4_8_1)  
&emsp;[共通閉鎖の原則(CCP)](cpp_idioms.md#SS_4_8_2)  
&emsp;[共通再利用の原則(CRP)](cpp_idioms.md#SS_4_8_3)  
&emsp;[非循環依存の原則(ADP)](cpp_idioms.md#SS_4_8_4)  

[コード・ユニット](cpp_idioms.md#SS_4_9)  
&emsp;[ファイルペア](cpp_idioms.md#SS_4_9_1)  
&emsp;&emsp;[パッケージ内のファイルペアの配置](cpp_idioms.md#SS_4_9_1_1)  

&emsp;[パッケージ](cpp_idioms.md#SS_4_9_2)  
&emsp;[モジュール](cpp_idioms.md#SS_4_9_3)  

[Modern CMake project layout](cpp_idioms.md#SS_4_10)  
&emsp;[Modern CMake project layoutのカスタマイズ](cpp_idioms.md#SS_4_10_1)  

[コーディングスタイル](cpp_idioms.md#SS_4_11)  
&emsp;[AAAスタイル](cpp_idioms.md#SS_4_11_1)  
&emsp;[east-const](cpp_idioms.md#SS_4_11_2)  
&emsp;[west-const](cpp_idioms.md#SS_4_11_3)  
&emsp;[Trailing Underscore(末尾アンダースコア)](cpp_idioms.md#SS_4_11_4)  
&emsp;[ケース記法](cpp_idioms.md#SS_4_11_5)  
&emsp;&emsp;[スネークケース(snake_case)](cpp_idioms.md#SS_4_11_5_1)  
&emsp;&emsp;[アッパースネークケース(UPPER_SNAKE_CASE)](cpp_idioms.md#SS_4_11_5_2)  
&emsp;&emsp;[アッパーキャメルケース(UpperCamelCase)](cpp_idioms.md#SS_4_11_5_3)  
&emsp;&emsp;[ロワーキャメルケース(lowerCamelCase)](cpp_idioms.md#SS_4_11_5_4)  
&emsp;&emsp;[ケバブケース(kebab-case)](cpp_idioms.md#SS_4_11_5_5)  

[オブジェクトのコピー](cpp_idioms.md#SS_4_12)  
&emsp;[シャローコピー](cpp_idioms.md#SS_4_12_1)  
&emsp;[ディープコピー](cpp_idioms.md#SS_4_12_2)  
&emsp;[スライシング](cpp_idioms.md#SS_4_12_3)  

[C++注意点](cpp_idioms.md#SS_4_13)  
&emsp;[オーバーライドとオーバーロードの違い](cpp_idioms.md#SS_4_13_1)  
&emsp;[danglingリファレンス](cpp_idioms.md#SS_4_13_2)  
&emsp;[danglingポインタ](cpp_idioms.md#SS_4_13_3)  
&emsp;[Most Vexing Parse](cpp_idioms.md#SS_4_13_4)  
&emsp;[Static Initialization Order Fiasco(静的初期化順序問題)](cpp_idioms.md#SS_4_13_5)  
&emsp;[Unbounded Functions](cpp_idioms.md#SS_4_13_6)  

[ソフトウェア一般](cpp_idioms.md#SS_4_14)  
&emsp;[ヒープ](cpp_idioms.md#SS_4_14_1)  
&emsp;[プライオリティインバージョン](cpp_idioms.md#SS_4_14_2)  
&emsp;[スレッドセーフ](cpp_idioms.md#SS_4_14_3)  
&emsp;[リエントラント](cpp_idioms.md#SS_4_14_4)  
&emsp;[クリティカルセクション](cpp_idioms.md#SS_4_14_5)  
&emsp;[スピンロック](cpp_idioms.md#SS_4_14_6)  
&emsp;[ミックスイン](cpp_idioms.md#SS_4_14_7)  
&emsp;[ハンドル](cpp_idioms.md#SS_4_14_8)  
&emsp;[フリースタンディング環境](cpp_idioms.md#SS_4_14_9)  
&emsp;[メモリ保護機構](cpp_idioms.md#SS_4_14_10)  
&emsp;[CPU例外](cpp_idioms.md#SS_4_14_11)  
&emsp;[Fluent Interface](cpp_idioms.md#SS_4_14_12)  
&emsp;[サイクロマティック複雑度](cpp_idioms.md#SS_4_14_13)  
&emsp;[凝集性](cpp_idioms.md#SS_4_14_14)  
&emsp;&emsp;[凝集性の欠如](cpp_idioms.md#SS_4_14_14_1)  
&emsp;&emsp;[LCOM](cpp_idioms.md#SS_4_14_14_2)  
&emsp;&emsp;[PercentLackOfCohesion](cpp_idioms.md#SS_4_14_14_3)  

&emsp;[Spurious Wakeup](cpp_idioms.md#SS_4_14_15)  
&emsp;[副作用](cpp_idioms.md#SS_4_14_16)  
&emsp;[Itanium C++ ABI](cpp_idioms.md#SS_4_14_17)  

[C++コンパイラ](cpp_idioms.md#SS_4_15)  
&emsp;[g++](cpp_idioms.md#SS_4_15_1)  
&emsp;[clang++](cpp_idioms.md#SS_4_15_2)  

[非ソフトウェア用語](cpp_idioms.md#SS_4_16)  
&emsp;[セマンティクス](cpp_idioms.md#SS_4_16_1)  
&emsp;[割れ窓理論](cpp_idioms.md#SS_4_16_2)  
&emsp;[車輪の再発明](cpp_idioms.md#SS_4_16_3)  

[DAG(有向非循環グラフ)](cpp_idioms.md#SS_4_17)  
...
### 前方宣言ヘッダ(`_fwd.h`) <a id="SS_4_1_2"></a>
...
この種の不整合(例えば[ODR](core_lang_spec.md#SS_2_14_10)違反)は、たとえ発生してもコンパイラが直ちに検出できるとは限らず、
実行時の[未定義動作](core_lang_spec.md#SS_2_14_3)や、原因の特定に長時間を要する難解なコンパイルエラーという形で顕在化することも少なくない。
...
### RAII(scoped guard) <a id="SS_4_1_3"></a>
...
[特殊メンバ関数](core_lang_spec.md#SS_2_6_1)では機能が不十分であることが多い。
...
### CRTP(curiously recurring template pattern) <a id="SS_4_1_5"></a>
CRTPとは、
...
以下にこのパターンを使用した[ミックスイン](cpp_idioms.md#SS_4_14_7)の例を示す。
...
一方で、「[Accessor](cpp_idioms.md#SS_4_1_6)」で紹介したsetterは、クラスのimmutabilityを下げる。
...
### NVI(non virtual interface) <a id="SS_4_1_8"></a>
...
ような場合に使用する。
そのため[オープン・クローズドの原則(OCP)](essential_appendix.md#SS_5_3)の実装方法としても有用である。
...
[Pimpl](cpp_idioms.md#SS_4_2_1)の解説で示したように依存関係をシンプルに保つには極めて有効なパターンではあるが、
...
ヒープ以外のメモリからnewするための[プレースメントnew](core_lang_spec.md#SS_2_6_9)を使用しているため、
...
* クラスの理解が曖昧なC++プログラマの理解を助ける(「[ポリモーフィックなクラス](core_lang_spec.md#SS_2_4_8)」参照)
...
bird::flyのオーバーライド関数(penguin::fly)について、[リスコフの置換原則(LSP)](essential_appendix.md#SS_5_4)に反した例を下記する。
...
kyukanchoとstd::stringの関係を[has-a](cpp_idioms.md#SS_4_3_2)の関係と呼ぶ。
...
自身の機能を提供する場合に使われる。
[has-a](cpp_idioms.md#SS_4_3_2)の関係は、is-implemented-in-terms-of の関係の一種である。

is-implemented-in-terms-ofは下記の手段1-3に示した方法がある。

* 手段1.[public継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_4_3_3_1)  
* 手段2.[private継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_4_3_3_2)  
* 手段3.[コンポジションによる(has-a)is-implemented-in-terms-of](cpp_idioms.md#SS_4_3_3_3)  
...
手段1は[is-a](cpp_idioms.md#SS_4_3_1)に見え、以下に示すような問題も考慮する必要があるため、
可読性、保守性を劣化させる可能性がある。
...
すでに述べたようにこの方法は、
[private継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_4_3_3_2)や、
[コンポジションによる(has-a)is-implemented-in-terms-of](cpp_idioms.md#SS_4_3_3_3)
と比べコードがシンプルになる。 
...
この方法は、[public継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_4_3_3_1)が持つデストラクタ問題は発生せす、
[is-a](cpp_idioms.md#SS_4_3_1)と誤解してしまう問題も発生しない。
...
オブジェクトの所有権やその移動、
std::unique_ptr、std::move()、[rvalue](core_lang_spec.md#SS_2_7_1_2)の関係を解説する。
...
下記に示した上記クラスの単体テストにより、
オブジェクトの所有権やその移動、共有、
std::shared_ptr、std::move()、[rvalue](core_lang_spec.md#SS_2_7_1_2)の関係を解説する。
...
* 下記のようなコードはstd::shared_ptrの仕様が想定する[セマンティクス](cpp_idioms.md#SS_4_16_1)に沿っておらず、
  [未定義動作](core_lang_spec.md#SS_2_14_3)に繋がる。
...
組み込みの==やオーバーロード[==演算子](core_lang_spec.md#SS_2_6_3)のこのような性質をここでは「等価性のセマンティクス」と呼ぶ。
...
この問題は、「[RTTI](core_lang_spec.md#SS_2_4_9)」使った下記のようなコードで対処できる。
...
下記に示す通り、このコードは、
[オープン・クローズドの原則(OCP)](essential_appendix.md#SS_5_3)にも対応した柔軟な構造を実現している。
...
文字列リテラルからstd::stringへの[暗黙の型変換](core_lang_spec.md#SS_2_6_2_2)が起こるために成立する。
...
従って、これらのオブジェクトに対して[等価性のセマンティクス](cpp_idioms.md#SS_4_5_1)
...
下記の単体テストから明らかな通り、
「[等価性のセマンティクス](cpp_idioms.md#SS_4_5_1)」で示した最後の例も、copyセマンティクスを満たしていない。
...
原因は、copy代入で[スライシング](cpp_idioms.md#SS_4_12_3)が起こるためである。
...
4. 効率性  
   ...
   これは、リソースの複製を避けることで達成される(「[moveセマンティクス](cpp_idioms.md#SS_4_5_3)」参照)。
...
3. 正しいセマンティクス  
   copy代入によって代入元のオブジェクトが変更されてはならない(「[copyセマンティクス](cpp_idioms.md#SS_4_5_2)」参照)。
...
[注]
`templat<typename T> f(T&&)`の`T&&`は[forwardingリファレンス](core_lang_spec.md#SS_2_8_3)である。  
...
関数構造の適・不適については、[サイクロマティック複雑度](cpp_idioms.md#SS_4_14_13)によって下記テーブルのように定義する。
...
リソース管理を専門とするクラス
(例: 標準ライブラリの[RAII(scoped guard)](cpp_idioms.md#SS_4_1_3)クラス)に任せる設計ガイドラインを指す。
...
デフォルトコンストラクタを除く[特殊メンバ関数](core_lang_spec.md#SS_2_6_1)、
...
自動生成されるメンバ関数では、
複雑なリソース管理の要件を満たせないことがある(「[シャローコピー](cpp_idioms.md#SS_4_12_1)」参照)。

なお、「五の原則」は、「六の原則」と呼ばれることもある。
その場合、この原則が対象とする関数は、
[特殊メンバ関数](core_lang_spec.md#SS_2_6_1)のすべてとなる。

このガイドラインに従って、コピーやムーブを実装する場合、

* [等価性のセマンティクス](cpp_idioms.md#SS_4_5_1)
* [copyセマンティクス](cpp_idioms.md#SS_4_5_2)
...
クラス構造の適・不適については、[PercentLackOfCohesion](cpp_idioms.md#SS_4_14_14_3)によって下記テーブルのように定義することができる。
...
* `PercentLackOfCohesion  <= 40`  
  クラスが非常に凝集しており、[単一責任の原則(SRP)](essential_appendix.md#SS_5_2)を強く遵守している状態であるため、
  通常、デザインの見直しは不要である。
...
## Robert C. Martinのコンポーネント原則 <a id="SS_4_8"></a>
...
それと一体で判断すべき依存構造の原則 [非循環依存の原則(ADP)](cpp_idioms.md#SS_4_8_4)を用いる。

| 原則                           | 一文での定義                             | 視点   | 力の向き／作用   |
|:------------------------------ |:-----------------------------------------|:-------|:-----------------|
| [リリース等価の原則(REP)](cpp_idioms.md#SS_4_8_1) | リリースノートが一本の筋として書けるか   | 提供側 | 凝集（まとめる） |
| [共通閉鎖の原則(CCP)](cpp_idioms.md#SS_4_8_2)     | 変更される理由が一つか                   | 提供側 | 凝集（まとめる） |
| [共通再利用の原則(CRP)](cpp_idioms.md#SS_4_8_3)   | 利用者に不要な依存まで抱えさせていないか | 利用側 | 分割（割る）     |
 
### リリース等価の原則(REP) <a id="SS_4_8_1"></a>
...
CCPは、[リリース等価の原則(REP)](cpp_idioms.md#SS_4_8_1)と同様に「パッケージをまとめることの根拠」になり得る。

### 共通再利用の原則(CRP) <a id="SS_4_8_3"></a>
...
[インターフェース分離の原則(ISP)](essential_appendix.md#SS_5_5)をライブラリ粒度へ適用したものに相当する。
[リリース等価の原則(REP)](cpp_idioms.md#SS_4_8_1)/[共通閉鎖の原則(CCP)](cpp_idioms.md#SS_4_8_2)とは逆に、「パッケージを分割することの根拠」になり得る。


### 非循環依存の原則(ADP) <a id="SS_4_8_4"></a>
ADPとは、Acyclic Dependencies Principle(非循環依存の原則)の略称であり、
ライブラリ間の依存関係に循環を作ってはならない、という原則である。
依存グラフは後述の[DAG(有向非循環グラフ)](cpp_idioms.md#SS_4_17)でなければならない。
循環があると、ライブラリを独立してビルド・テスト・リリースすることが困難になる。

---

## コード・ユニット <a id="SS_4_9"></a>
...
|ヘッダファイル|`*.h` `*.hpp` `*.hxx`                                                                           |
|実装ファイル  |`*.c` `*.cpp` `*.cxx`                                                                           |
|ファイルペア  |`name.h`と`name.c`の組み合わせ /「[ファイルペア](cpp_idioms.md#SS_4_9_1)」で解説                                   |
|モジュール    |モジュール ≒  パッケージ / 「[モジュール](cpp_idioms.md#SS_4_9_3)」で解説                                          |
|パッケージ    |「[パッケージ](cpp_idioms.md#SS_4_9_2)」で解説 / CMake([Modern CMake project layout](cpp_idioms.md#SS_4_10))のビルド単位(ライブラリ) |

ここでは、これらの概念に意味と定義を与える。

- ファイルペア ＝ １つの実装ファイルとヘッダファイル(稀に、実装ファイルやヘッダファイルのみ)
- パッケージ(CMakeのビルド単位) ≒  [Robert C. Martinのコンポーネント原則](cpp_idioms.md#SS_4_8)における「コンポーネント」
- パッケージ(CMakeのビルド単位) ∋  (複数の似た機能を持つ)ファイルペア


### ファイルペア <a id="SS_4_9_1"></a>
...
- ファイルペアのファイルの配置は、「[パッケージ内のファイルペアの配置](cpp_idioms.md#SS_4_9_1_1)」で示す。 


#### パッケージ内のファイルペアの配置 <a id="SS_4_9_1_1"></a>
パッケージ内でのファイルペアのヘッダの配置は以下の２パターンのみでなければならない。

- [ファイルペアの機能をパッケージ内部でのみ使用する場合](cpp_idioms.md#SS_4_9_1_1_1)
- [ファイルペアの機能をパッケージが外部公開する場合](cpp_idioms.md#SS_4_9_1_1_2)

##### ファイルペアの機能をパッケージ内部でのみ使用する場合 <a id="SS_4_9_1_1_1"></a>
...
##### ファイルペアの機能をパッケージが外部公開する場合 <a id="SS_4_9_1_1_2"></a>
...
### パッケージ <a id="SS_4_9_2"></a>
このドキュメントでのパッケージとは、以下の特徴を持つソースコードツリーである。 

- **類似した機能**を持つ複数の[ファイルペア](cpp_idioms.md#SS_4_9_1)の集合体
- パッケージのソースコードは、専用のディレクトリの配下に配置され、[Modern CMake project layout](cpp_idioms.md#SS_4_10)と同等の形状を持つ。
- パッケージは専用の名前空間を持つ。
- パッケージのビルド生成物はライブラリである。
- ライブラリ粒度の凝集性は、関数レベル/クラスの古典的凝集度分類ではなく、[Robert C. Martinのコンポーネント原則](cpp_idioms.md#SS_4_8)
  (「[Robert C. Martinのコンポーネント原則](cpp_idioms.md#SS_4_8)」のコンポーネントとはこのドキュメントではパッケージを指す)で判断する。
  中核は次の三原則のパワーバランスである。
    - [リリース等価の原則(REP)](cpp_idioms.md#SS_4_8_1)
    - [共通閉鎖の原則(CCP)](cpp_idioms.md#SS_4_8_2)
    - [共通再利用の原則(CRP)](cpp_idioms.md#SS_4_8_3)
...
- **CRP は利用側の問い**: 「利用者はこれを丸ごと使うか。使わない物まで巻き込ませていないか？」。  
  パッケージ版の[インターフェース分離の原則(ISP)](essential_appendix.md#SS_5_5)と考えて差し支えない。
...
とし、[パッケージ](cpp_idioms.md#SS_4_9_2)としてその粒度を詳細に定義付けている。
...
## Modern CMake project layout <a id="SS_4_10"></a>
...
### Modern CMake project layoutのカスタマイズ <a id="SS_4_10_1"></a>
このドキュメントでは、以下の方針に基づいて[Modern CMake project layout](cpp_idioms.md#SS_4_10)の構成をカスタマイズすることを推奨する。
...
## コーディングスタイル <a id="SS_4_11"></a>
### AAAスタイル <a id="SS_4_11_1"></a>
...
### Trailing Underscore(末尾アンダースコア) <a id="SS_4_11_4"></a>
...
### ケース記法 <a id="SS_4_11_5"></a>
C++の識別子の命名規則(Naming convention)を以下のようにリストアップする。

* [スネークケース(snake_case)](cpp_idioms.md#SS_4_11_5_1)
* [アッパースネークケース(UPPER_SNAKE_CASE)](cpp_idioms.md#SS_4_11_5_2)
* [アッパーキャメルケース(UpperCamelCase)](cpp_idioms.md#SS_4_11_5_3)
* [ロワーキャメルケース(lowerCamelCase)](cpp_idioms.md#SS_4_11_5_4)
* [ケバブケース(kebab-case)](cpp_idioms.md#SS_4_11_5_5)

#### スネークケース(snake_case) <a id="SS_4_11_5_1"></a>
...
#### アッパースネークケース(UPPER_SNAKE_CASE) <a id="SS_4_11_5_2"></a>
...
#### アッパーキャメルケース(UpperCamelCase) <a id="SS_4_11_5_3"></a>
...
#### ロワーキャメルケース(lowerCamelCase) <a id="SS_4_11_5_4"></a>
...
#### ケバブケース(kebab-case) <a id="SS_4_11_5_5"></a>
...
## オブジェクトのコピー <a id="SS_4_12"></a>
### シャローコピー <a id="SS_4_12_1"></a>
シャローコピー(浅いコピー)とは、暗黙的、
もしくは=defaultによってコンパイラが生成するようなcopyコンストラクタ、
copy代入演算子が行うコピーであり、[ディープコピー](cpp_idioms.md#SS_4_12_2)と対比的に使われる概念である。
...
### ディープコピー <a id="SS_4_12_2"></a>
ディープコピーとは、[シャローコピー](cpp_idioms.md#SS_4_12_1)が発生させる問題を回避したコピーである。
...
### danglingリファレンス <a id="SS_4_13_2"></a>
Dangling リファレンスとは、破棄後のオブジェクトを指しているリファレンスを指す。
このようなリファレンスにアクセスすると、[未定義動作](core_lang_spec.md#SS_2_14_3)に繋がるに繋がる。
...
### danglingポインタ <a id="SS_4_13_3"></a>
danglingポインタとは、[danglingリファレンス](cpp_idioms.md#SS_4_13_2)と同じような状態になったポインタを指す。


---

### Most Vexing Parse <a id="SS_4_13_4"></a>
...
### Static Initialization Order Fiasco(静的初期化順序問題) <a id="SS_4_13_5"></a>
静的初期化順序問題とは、
...
C++20からこの問題の対策として、[constinit](core_lang_spec.md#SS_2_5_8)が導入された。

[初期化子リストコンストラクタ](core_lang_spec.md#SS_2_6_1_1)の呼び出しでオブジェクトの初期化を行うことで、
このような問題を回避できる。

### Unbounded Functions <a id="SS_4_13_6"></a>
...
## ソフトウェア一般 <a id="SS_4_14"></a>
### ヒープ <a id="SS_4_14_1"></a>
...
### プライオリティインバージョン <a id="SS_4_14_2"></a>
...
### ミックスイン <a id="SS_4_14_7"></a>
ミックスインとは、オブジェクト指向プログラミングにおいて、
複数のクラスに対して特定の機能やメソッドを提供するための設計パターンである。
「混ぜ込む（mix in）」という名称が示すとおり、既存のクラスに機能を追加する目的で使用される。

C++では[CRTP(curiously recurring template pattern)](cpp_idioms.md#SS_4_1_5)や通常の継承によってミックスインを実現する。

---

### ハンドル <a id="SS_4_14_8"></a>
CやC++の文脈でのハンドルとは、ポインタかリファレンスを指す。

---

### フリースタンディング環境 <a id="SS_4_14_9"></a>
...
- メモリ保護違反例外:
    [メモリ保護機構](cpp_idioms.md#SS_4_14_10)の設定に反した命令を実行した場合に発生する。例えば、リードオンリー領域への書き込み、
...
### Fluent Interface <a id="SS_4_14_12"></a>
...
### サイクロマティック複雑度 <a id="SS_4_14_13"></a>
[サイクロマティック複雑度](https://ja.wikipedia.org/wiki/%E5%BE%AA%E7%92%B0%E7%9A%84%E8%A4%87%E9%9B%91%E5%BA%A6)
とは関数の複雑さを表すメトリクスである。

---

### 凝集性 <a id="SS_4_14_14"></a>
[凝集性(凝集度)](https://ja.wikipedia.org/wiki/%E5%87%9D%E9%9B%86%E5%BA%A6)
とはクラス設計の妥当性を表す尺度の一種であり、「[PercentLackOfCohesion](cpp_idioms.md#SS_4_14_14_3)」というメトリクスで計測される。

* [凝集性の欠如](cpp_idioms.md#SS_4_14_14_1)メトリクスの値が100に近ければ凝集性は低く、この値が0に近ければ凝集性は高い。
* メンバ変数やメンバ関数が多くなれば、凝集性は低くなりやすい。
* 凝集性は、クラスのメンバがどれだけ一貫した責任を持つかを示す。
* 「[単一責任の原則(SRP)](essential_appendix.md#SS_5_2)」を守ると凝集性は高くなりやすい。
* 「[Accessor](cpp_idioms.md#SS_4_1_6)」を多用すれば、振る舞いが分散しがちになるため、通常、凝集性は低くなる。
   従って、下記のようなクラスは凝集性が低い。言い換えれば、凝集性を下げることなく、
   より小さいクラスに分割できる。
   なお、以下のクラスでは、実際に計測すると、[PercentLackOfCohesion](cpp_idioms.md#SS_4_14_14_3)が100に近い値となっている。
...
(ただし、「[Immutable](cpp_idioms.md#SS_4_1_7)」の観点からは、QuadraticEquation::Set()がない方が良い)。
...
#### 凝集性の欠如 <a id="SS_4_14_14_1"></a>
[凝集性の欠如](cpp_idioms.md#SS_4_14_14_1)とはLack of Cohesion in Methodsの和訳であり、[LCOM](cpp_idioms.md#SS_4_14_14_2)と呼ばれる。

LCOMはメソッドペアの数に基づく非正規化の整数値であるため、
メソッド数が多いクラスほど値が大きくなりやすく、クラス間で単純に値の大小を比較することはできない。
この弱点を補う指標として実務上広く用いられるのが、[PercentLackOfCohesion](cpp_idioms.md#SS_4_14_14_3)である。
...
#### PercentLackOfCohesion <a id="SS_4_14_14_3"></a>
厳密性を欠くが、クラスの凝集性を測定するためには、
テクマトリックス社製のUnderstandのメトリクスPercentLackOfCohesionを使用するのが実践的である。

PercentLackOfCohesionは、[LCOM](cpp_idioms.md#SS_4_14_14_2)と同様に使用できるメトリクスであり、0〜100に正規化された値である。

[クラス凝集性のクライテリア](cpp_idioms.md#SS_4_7_3)に示した通り、構造的欠陥をを持つクラスの自動的な抽出に有用である。

---

### Spurious Wakeup <a id="SS_4_14_15"></a>
...
### Itanium C++ ABI <a id="SS_4_14_17"></a>
...
[g++](cpp_idioms.md#SS_4_15_1)や[clang++](cpp_idioms.md#SS_4_15_2)はx86/x86-64やARM64など多くのプラットフォームでもItaniumC++ABI準拠の規約を採用している。
...
## 非ソフトウェア用語 <a id="SS_4_16"></a>
### セマンティクス <a id="SS_4_16_1"></a>
