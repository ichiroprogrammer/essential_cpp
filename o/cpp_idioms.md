...
&emsp;&emsp; [オブジェクト指向](cpp_idioms.md#SS_4_1)  
&emsp;&emsp;&emsp; [is-a](cpp_idioms.md#SS_4_1_1)  
&emsp;&emsp;&emsp; [has-a](cpp_idioms.md#SS_4_1_2)  
&emsp;&emsp;&emsp; [is-implemented-in-terms-of](cpp_idioms.md#SS_4_1_3)  
&emsp;&emsp;&emsp;&emsp; [public継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_4_1_3_1)  
&emsp;&emsp;&emsp;&emsp; [private継承によるis-implemented-in-terms-of](cpp_idioms.md#SS_4_1_3_2)  
&emsp;&emsp;&emsp;&emsp; [コンポジションによる(has-a)is-implemented-in-terms-of](cpp_idioms.md#SS_4_1_3_3)  

&emsp;&emsp; [オブジェクトの所有権](cpp_idioms.md#SS_4_2)  
&emsp;&emsp;&emsp; [オブジェクトの排他所有](cpp_idioms.md#SS_4_2_1)  
&emsp;&emsp;&emsp; [オブジェクトの共有所有](cpp_idioms.md#SS_4_2_2)  
&emsp;&emsp;&emsp; [オブジェクトの循環所有](cpp_idioms.md#SS_4_2_3)  

&emsp;&emsp; [copy/moveと等価性のセマンティクス](cpp_idioms.md#SS_4_3)  
&emsp;&emsp;&emsp; [等価性のセマンティクス](cpp_idioms.md#SS_4_3_1)  
&emsp;&emsp;&emsp; [copyセマンティクス](cpp_idioms.md#SS_4_3_2)  
&emsp;&emsp;&emsp; [moveセマンティクス](cpp_idioms.md#SS_4_3_3)  
&emsp;&emsp;&emsp; [MoveAssignable要件](cpp_idioms.md#SS_4_3_4)  
&emsp;&emsp;&emsp; [CopyAssignable要件](cpp_idioms.md#SS_4_3_5)  

&emsp;&emsp; [関数設計のガイドライン](cpp_idioms.md#SS_4_4)  
&emsp;&emsp;&emsp; [関数の引数と戻り値の型](cpp_idioms.md#SS_4_4_1)  
&emsp;&emsp;&emsp; [サイクロマティック複雑度のクライテリア](cpp_idioms.md#SS_4_4_2)  
&emsp;&emsp;&emsp; [関数の行数のクライテリア](cpp_idioms.md#SS_4_4_3)  

&emsp;&emsp; [クラス設計のガイドライン](cpp_idioms.md#SS_4_5)  
&emsp;&emsp;&emsp; [ゼロの原則(Rule of Zero)](cpp_idioms.md#SS_4_5_1)  
&emsp;&emsp;&emsp; [五の原則(Rule of Five)](cpp_idioms.md#SS_4_5_2)  
&emsp;&emsp;&emsp; [クラス凝集性のクライテリア](cpp_idioms.md#SS_4_5_3)  

&emsp;&emsp; [コーディングスタイル](cpp_idioms.md#SS_4_6)  
&emsp;&emsp;&emsp; [AAAスタイル](cpp_idioms.md#SS_4_6_1)  
&emsp;&emsp;&emsp; [east-const](cpp_idioms.md#SS_4_6_2)  
&emsp;&emsp;&emsp; [west-const](cpp_idioms.md#SS_4_6_3)  

&emsp;&emsp; [オブジェクトのコピー](cpp_idioms.md#SS_4_7)  
&emsp;&emsp;&emsp; [シャローコピー](cpp_idioms.md#SS_4_7_1)  
&emsp;&emsp;&emsp; [ディープコピー](cpp_idioms.md#SS_4_7_2)  
&emsp;&emsp;&emsp; [スライシング](cpp_idioms.md#SS_4_7_3)  

&emsp;&emsp; [C++注意点](cpp_idioms.md#SS_4_8)  
&emsp;&emsp;&emsp; [オーバーライドとオーバーロードの違い](cpp_idioms.md#SS_4_8_1)  
&emsp;&emsp;&emsp; [danglingリファレンス](cpp_idioms.md#SS_4_8_2)  
&emsp;&emsp;&emsp; [danglingポインタ](cpp_idioms.md#SS_4_8_3)  
&emsp;&emsp;&emsp; [Most Vexing Parse](cpp_idioms.md#SS_4_8_4)  

&emsp;&emsp; [ソフトウェア一般](cpp_idioms.md#SS_4_9)  
&emsp;&emsp;&emsp; [ヒープ](cpp_idioms.md#SS_4_9_1)  
&emsp;&emsp;&emsp; [スレッドセーフ](cpp_idioms.md#SS_4_9_2)  
&emsp;&emsp;&emsp; [リエントラント](cpp_idioms.md#SS_4_9_3)  
&emsp;&emsp;&emsp; [クリティカルセクション](cpp_idioms.md#SS_4_9_4)  
&emsp;&emsp;&emsp; [スピンロック](cpp_idioms.md#SS_4_9_5)  
&emsp;&emsp;&emsp; [ハンドル](cpp_idioms.md#SS_4_9_6)  
&emsp;&emsp;&emsp; [フリースタンディング環境](cpp_idioms.md#SS_4_9_7)  
&emsp;&emsp;&emsp; [サイクロマティック複雑度](cpp_idioms.md#SS_4_9_8)  
&emsp;&emsp;&emsp; [凝集性](cpp_idioms.md#SS_4_9_9)  
&emsp;&emsp;&emsp;&emsp; [凝集性の欠如](cpp_idioms.md#SS_4_9_9_1)  
&emsp;&emsp;&emsp;&emsp; [LCOM](cpp_idioms.md#SS_4_9_9_2)  

&emsp;&emsp;&emsp; [Spurious Wakeup](cpp_idioms.md#SS_4_9_10)  
&emsp;&emsp;&emsp; [Static Initialization Order Fiasco(静的初期化順序問題)](cpp_idioms.md#SS_4_9_11)  
&emsp;&emsp;&emsp; [副作用](cpp_idioms.md#SS_4_9_12)  
&emsp;&emsp;&emsp; [Itanium C++ ABI](cpp_idioms.md#SS_4_9_13)  

&emsp;&emsp; [C++コンパイラ](cpp_idioms.md#SS_4_10)  
&emsp;&emsp;&emsp; [g++](cpp_idioms.md#SS_4_10_1)  
&emsp;&emsp;&emsp; [clang++](cpp_idioms.md#SS_4_10_2)  

&emsp;&emsp; [非ソフトウェア用語](cpp_idioms.md#SS_4_11)  
&emsp;&emsp;&emsp; [セマンティクス](cpp_idioms.md#SS_4_11_1)  
&emsp;&emsp;&emsp; [割れ窓理論](cpp_idioms.md#SS_4_11_2)  
&emsp;&emsp;&emsp; [車輪の再発明](cpp_idioms.md#SS_4_11_3)  
...
## オブジェクト指向 <a id="SS_4_1"></a>
### is-a <a id="SS_4_1_1"></a>
...
### is-implemented-in-terms-of <a id="SS_4_1_3"></a>
...
#### public継承によるis-implemented-in-terms-of <a id="SS_4_1_3_1"></a>
...
## オブジェクトの所有権 <a id="SS_4_2"></a>
### オブジェクトの排他所有 <a id="SS_4_2_1"></a>
...
* 下記のようなコードはstd::shared_ptrの仕様が想定する[セマンティクス](cpp_idioms.md#SS_4_11_1)に沿っておらず、
...
X、Yオブジェクトへの[ハンドル](cpp_idioms.md#SS_4_9_6)を完全に失った状態であり、X、Yオブジェクトを解放する手段はない。

## copy/moveと等価性のセマンティクス <a id="SS_4_3"></a>
### 等価性のセマンティクス <a id="SS_4_3_1"></a>
...
### copyセマンティクス <a id="SS_4_3_2"></a>
copyセマンティクスとは以下を満たすようなセマンティクスである。

* a = bが行われた後に、aとbが等価である。
* a = bが行われた前後でbの値が変わっていない。

従って、これらのオブジェクトに対して[等価性のセマンティクス](cpp_idioms.md#SS_4_3_1)
...
下記の単体テストから明らかな通り、
「[等価性のセマンティクス](cpp_idioms.md#SS_4_3_1)」で示した最後の例も、copyセマンティクスを満たしていない。
...
原因は、copy代入で[スライシング](cpp_idioms.md#SS_4_7_3)が起こるためである。


### moveセマンティクス <a id="SS_4_3_3"></a>
...
### MoveAssignable要件 <a id="SS_4_3_4"></a>
...
4. 効率性  
   ...
   これは、リソースの複製を避けることで達成される(「[moveセマンティクス](cpp_idioms.md#SS_4_3_3)」参照)。
...
### CopyAssignable要件 <a id="SS_4_3_5"></a>
...
3. 正しいセマンティクス  
   copy代入によって代入元のオブジェクトが変更されてはならない(「[copyセマンティクス](cpp_idioms.md#SS_4_3_2)」参照)。
...
### サイクロマティック複雑度のクライテリア <a id="SS_4_4_2"></a>
関数構造の適・不適については、[サイクロマティック複雑度](cpp_idioms.md#SS_4_9_8)によって下記テーブルのように定義する。
...
## クラス設計のガイドライン <a id="SS_4_5"></a>
### ゼロの原則(Rule of Zero) <a id="SS_4_5_1"></a>
「ゼロの原則」は、リソース管理を直接クラスで行わず、
リソース管理を専門とするクラス
(例: 標準ライブラリの[RAII(scoped guard)](design_pattern.md#SS_6_10)クラス)に任せる設計ガイドラインを指す。
...
### 五の原則(Rule of Five) <a id="SS_4_5_2"></a>
「五の原則」は、
...
自動生成されるメンバ関数では、
複雑なリソース管理の要件を満たせないことがある(「[シャローコピー](cpp_idioms.md#SS_4_7_1)」参照)。
...
* [等価性のセマンティクス](cpp_idioms.md#SS_4_3_1)
* [copyセマンティクス](cpp_idioms.md#SS_4_3_2)
* [moveセマンティクス](cpp_idioms.md#SS_4_3_3)

に従わなけならない。

### クラス凝集性のクライテリア <a id="SS_4_5_3"></a>
クラス構造の適・不適については、[LCOM](cpp_idioms.md#SS_4_9_9_2)によって下記テーブルのように定義する。
...
## コーディングスタイル <a id="SS_4_6"></a>
### AAAスタイル <a id="SS_4_6_1"></a>
...
## オブジェクトのコピー <a id="SS_4_7"></a>
### シャローコピー <a id="SS_4_7_1"></a>
シャローコピー(浅いコピー)とは、暗黙的、
もしくは=defaultによってコンパイラが生成するようなcopyコンストラクタ、
copy代入演算子が行うコピーであり、[ディープコピー](cpp_idioms.md#SS_4_7_2)と対比的に使われる概念である。
...
### ディープコピー <a id="SS_4_7_2"></a>
ディープコピーとは、[シャローコピー](cpp_idioms.md#SS_4_7_1)が発生させる問題を回避したコピーである。
...
スライシングが起こった場合、そうならないことが問題である(「[等価性のセマンティクス](cpp_idioms.md#SS_4_3_1)」参照)。
...
## C++注意点 <a id="SS_4_8"></a>
### オーバーライドとオーバーロードの違い <a id="SS_4_8_1"></a>
...
### danglingリファレンス <a id="SS_4_8_2"></a>
...
### danglingポインタ <a id="SS_4_8_3"></a>
danglingポインタとは、[danglingリファレンス](cpp_idioms.md#SS_4_8_2)と同じような状態になったポインタを指す。


### Most Vexing Parse <a id="SS_4_8_4"></a>
...
### ハンドル <a id="SS_4_9_6"></a>
CやC++の文脈でのハンドルとは、ポインタかリファレンスを指す。

### フリースタンディング環境 <a id="SS_4_9_7"></a>
...
「[凝集性の欠如](cpp_idioms.md#SS_4_9_9_1)(LCOM)」というメトリクスで計測される。

* [凝集性の欠如](cpp_idioms.md#SS_4_9_9_1)メトリクスの値が1に近ければ凝集性は低く、この値が0に近ければ凝集性は高い。
* メンバ変数やメンバ関数が多くなれば、凝集性は低くなりやすい。
* 凝集性は、クラスのメンバがどれだけ一貫した責任を持つかを示す。
* 「[単一責任の原則(SRP)](solid.md#SS_5_1)」を守ると凝集性は高くなりやすい。
* 「[Accessor](design_pattern.md#SS_6_5)」を多用すれば、振る舞いが分散しがちになるため、通常、凝集性は低くなる。
...
(ただし、「[Immutable](design_pattern.md#SS_6_7)」の観点からは、QuadraticEquation::Set()がない方が良い)。
...
#### 凝集性の欠如 <a id="SS_4_9_9_1"></a>
[凝集性](cpp_idioms.md#SS_4_9_9)の欠如(Lack of Cohesion in Methods/LCOM)とは、
...
クラスデザイン見直しの基準値としてLCOMを活用する場合、[クラス凝集性のクライテリア](cpp_idioms.md#SS_4_5_3)に具体的な推奨値を示す。

#### LCOM <a id="SS_4_9_9_2"></a>
[凝集性の欠如](cpp_idioms.md#SS_4_9_9_1)とはLack of Cohesion in Methodsの和訳であり、LCOMと呼ばれる。

### Spurious Wakeup <a id="SS_4_9_10"></a>
...
### Static Initialization Order Fiasco(静的初期化順序問題) <a id="SS_4_9_11"></a>
静的初期化順序問題とは、
...
### Itanium C++ ABI <a id="SS_4_9_13"></a>
...
[g++](cpp_idioms.md#SS_4_10_1)や[clang++](cpp_idioms.md#SS_4_10_2)はx86/x86-64やARM64など多くのプラットフォームでもItaniumC++ABI準拠の規約を採用している。
...
## 非ソフトウェア用語 <a id="SS_4_11"></a>
### セマンティクス <a id="SS_4_11_1"></a>
