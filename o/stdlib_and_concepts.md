...
&emsp;&emsp; [標準エクセプションクラス](stdlib_and_concepts.md#SS_3_3)  
&emsp;&emsp;&emsp; [std::exception](stdlib_and_concepts.md#SS_3_3_1)  

&emsp;&emsp; [並列処理](stdlib_and_concepts.md#SS_3_4)  
&emsp;&emsp;&emsp; [std::thread](stdlib_and_concepts.md#SS_3_4_1)  
&emsp;&emsp;&emsp; [std::mutex](stdlib_and_concepts.md#SS_3_4_2)  
&emsp;&emsp;&emsp; [std::atomic](stdlib_and_concepts.md#SS_3_4_3)  
&emsp;&emsp;&emsp; [std::condition_variable](stdlib_and_concepts.md#SS_3_4_4)  

&emsp;&emsp; [ロック所有ラッパー](stdlib_and_concepts.md#SS_3_5)  
&emsp;&emsp;&emsp; [std::lock_guard](stdlib_and_concepts.md#SS_3_5_1)  
&emsp;&emsp;&emsp; [std::unique_lock](stdlib_and_concepts.md#SS_3_5_2)  
&emsp;&emsp;&emsp; [std::scoped_lock](stdlib_and_concepts.md#SS_3_5_3)  

&emsp;&emsp; [スマートポインタ](stdlib_and_concepts.md#SS_3_6)  
&emsp;&emsp;&emsp; [std::unique_ptr](stdlib_and_concepts.md#SS_3_6_1)  
&emsp;&emsp;&emsp;&emsp; [std::make_unique](stdlib_and_concepts.md#SS_3_6_1_1)  

&emsp;&emsp;&emsp; [std::shared_ptr](stdlib_and_concepts.md#SS_3_6_2)  
&emsp;&emsp;&emsp;&emsp; [std::make_shared](stdlib_and_concepts.md#SS_3_6_2_1)  
&emsp;&emsp;&emsp;&emsp; [std::enable_shared_from_this](stdlib_and_concepts.md#SS_3_6_2_2)  

&emsp;&emsp;&emsp; [std::weak_ptr](stdlib_and_concepts.md#SS_3_6_3)  
&emsp;&emsp;&emsp; [std::auto_ptr](stdlib_and_concepts.md#SS_3_6_4)  

&emsp;&emsp; [Polymorphic Memory Resource(pmr)](stdlib_and_concepts.md#SS_3_7)  
&emsp;&emsp;&emsp; [std::pmr::memory_resource](stdlib_and_concepts.md#SS_3_7_1)  
&emsp;&emsp;&emsp; [std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_3_7_2)  
&emsp;&emsp;&emsp; [pool_resource](stdlib_and_concepts.md#SS_3_7_3)  

&emsp;&emsp; [コンテナ](stdlib_and_concepts.md#SS_3_8)  
&emsp;&emsp;&emsp; [シーケンスコンテナ(Sequence Containers)](stdlib_and_concepts.md#SS_3_8_1)  
&emsp;&emsp;&emsp;&emsp; [std::forward_list](stdlib_and_concepts.md#SS_3_8_1_1)  

&emsp;&emsp;&emsp; [連想コンテナ(Associative Containers)](stdlib_and_concepts.md#SS_3_8_2)  
&emsp;&emsp;&emsp; [無順序連想コンテナ(Unordered Associative Containers)](stdlib_and_concepts.md#SS_3_8_3)  
&emsp;&emsp;&emsp;&emsp; [std::unordered_set](stdlib_and_concepts.md#SS_3_8_3_1)  
&emsp;&emsp;&emsp;&emsp; [std::unordered_map](stdlib_and_concepts.md#SS_3_8_3_2)  
&emsp;&emsp;&emsp;&emsp; [std::type_index](stdlib_and_concepts.md#SS_3_8_3_3)  

&emsp;&emsp;&emsp; [コンテナアダプタ(Container Adapters)](stdlib_and_concepts.md#SS_3_8_4)  
&emsp;&emsp;&emsp; [特殊なコンテナ](stdlib_and_concepts.md#SS_3_8_5)  

&emsp;&emsp; [std::optional](stdlib_and_concepts.md#SS_3_9)  
&emsp;&emsp;&emsp; [戻り値の無効表現](stdlib_and_concepts.md#SS_3_9_1)  
&emsp;&emsp;&emsp; [オブジェクトの遅延初期化](stdlib_and_concepts.md#SS_3_9_2)  

&emsp;&emsp; [std::variant](stdlib_and_concepts.md#SS_3_10)  
&emsp;&emsp; [オブジェクトの比較](stdlib_and_concepts.md#SS_3_11)  
&emsp;&emsp;&emsp; [std::rel_ops](stdlib_and_concepts.md#SS_3_11_1)  
&emsp;&emsp;&emsp; [std::tuppleを使用した比較演算子の実装方法](stdlib_and_concepts.md#SS_3_11_2)  

&emsp;&emsp; [その他](stdlib_and_concepts.md#SS_3_12)  
&emsp;&emsp;&emsp; [SSO(Small String Optimization)](stdlib_and_concepts.md#SS_3_12_1)  
&emsp;&emsp;&emsp; [heap allocation elision](stdlib_and_concepts.md#SS_3_12_2)  
...
[クリティカルセクション](cpp_idioms.md#SS_4_12_5)と呼ぶ)が、std::mutexによりこの問題を回避している。
...
mutexは通常、[std::lock_guard](stdlib_and_concepts.md#SS_3_5_1)と組み合わせて使われる。
...
[std::mutex](stdlib_and_concepts.md#SS_3_4_2)で示したような単純なコードではstd::atomicを使用して下記のように書く方が一般的である。
...
最も単純な使用例を以下に示す(「[Spurious Wakeup](cpp_idioms.md#SS_4_12_14)」参照)。
```cpp
...
- [std::lock_guard](stdlib_and_concepts.md#SS_3_5_1)
- [std::unique_lock](stdlib_and_concepts.md#SS_3_5_2)
- [std::scoped_lock](stdlib_and_concepts.md#SS_3_5_3)
...
下記のコード例では、[std::lock_guard](stdlib_and_concepts.md#SS_3_5_1)の説明で述べたようにmutex::lock()、mutex::unlock()を直接呼び出すのではなく、
...
一般に条件変数には、[Spurious Wakeup](cpp_idioms.md#SS_4_12_14)という問題があり、std::condition_variableも同様である。

上記の抜粋である下記のコード例では[Spurious Wakeup](cpp_idioms.md#SS_4_12_14)の対策が行われていないため、
意図通り動作しない可能性がある。
...
* [std::unique_ptr](stdlib_and_concepts.md#SS_3_6_1)
    - [std::make_unique](stdlib_and_concepts.md#SS_3_6_1_1)
* [std::shared_ptr](stdlib_and_concepts.md#SS_3_6_2)
    - [std::make_shared](stdlib_and_concepts.md#SS_3_6_2_1)
    - [std::enable_shared_from_this](stdlib_and_concepts.md#SS_3_6_2_2)
    - [std::weak_ptr](stdlib_and_concepts.md#SS_3_6_3)
* [std::auto_ptr](stdlib_and_concepts.md#SS_3_6_4)
...
使用例については、「[オブジェクトの排他所有](cpp_idioms.md#SS_4_4_1)」を参照せよ。
...
[std::weak_ptr](stdlib_and_concepts.md#SS_3_6_3)は、shared_ptrと連携して使用されるスマートポインタであり、オブジェクトの非所有参照を表す。
...
使用例については、「[オブジェクトの共有所有](cpp_idioms.md#SS_4_4_2)」を参照せよ。
...
weak_ptrを返すため[オブジェクトの循環所有](cpp_idioms.md#SS_4_4_3)を避けたい場合に有用である。

### std::weak_ptr <a id="SS_3_6_3"></a>
std::weak_ptrは、スマートポインタの一種である。

std::weak_ptrは参照カウントに影響を与えず、[std::shared_ptr](stdlib_and_concepts.md#SS_3_6_2)とオブジェクトを共有所有するのではなく、
...
なお、上記コードは[初期化付きif文](core_lang_spec.md#SS_2_9_4_3)を使うことで、
...
[std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_3_7_2)はC++17で導入された標準ライブラリのクラスで、
...
* [std::pmr::memory_resource](stdlib_and_concepts.md#SS_3_7_1)  
* [std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_3_7_2)  
* [pool_resource](stdlib_and_concepts.md#SS_3_7_3)

### std::pmr::memory_resource <a id="SS_3_7_1"></a>
std::pmr::memory_resourceは、
ユーザー定義のメモリリソースをカスタマイズし、
[std::pmr::polymorphic_allocator](stdlib_and_concepts.md#SS_3_7_2)を通じて利用可能にする[インターフェースクラス](core_lang_spec.md#SS_2_4_11)である。
...
C++のメモリリソース管理を抽象化するための機能を提供する。
[std::pmr::memory_resource](stdlib_and_concepts.md#SS_3_7_1)を基盤とし、
コンテナやアルゴリズムにカスタムメモリアロケーション戦略を容易に適用可能にする。
std::allocatorと異なり、型に依存せず、
ポリモーフィズムを活用してメモリリソースを切り替えられる点が特徴である。

すでに示したmemory_resource_variable([std::pmr::memory_resource](stdlib_and_concepts.md#SS_3_7_1))の単体テストを以下に示すことにより、
...
pool_resourceは[std::pmr::memory_resource](stdlib_and_concepts.md#SS_3_7_1)を基底とする下記の2つの具象クラスである。
...
* [シーケンスコンテナ(Sequence Containers)](stdlib_and_concepts.md#SS_3_8_1)
* [連想コンテナ(Associative Containers)(---)
* [無順序連想コンテナ(Unordered Associative Containers)](stdlib_and_concepts.md#SS_3_8_3)
* [コンテナアダプタ(Container Adapters)](stdlib_and_concepts.md#SS_3_8_4)
* [特殊なコンテナ](stdlib_and_concepts.md#SS_3_8_5)
...
| [std::forward_list](stdlib_and_concepts.md#SS_3_8_1_1) | 単方向リスト。軽量だが、双方向の操作はできない                      |
...
| コンテナ                  | 説明                                                   |
|---------------------------|--------------------------------------------------------|
| [std::unordered_set](stdlib_and_concepts.md#SS_3_8_3_1) | ハッシュテーブルベースの集合。重複は許されない         |
| `std::unordered_multiset` | ハッシュテーブルベースの集合。重複が許される           |
| [std::unordered_map](stdlib_and_concepts.md#SS_3_8_3_2) | ハッシュテーブルベースのキーと値のペア。キーは一意     |
| `std::unordered_multimap` | ハッシュテーブルベースのキーと値のペア。キーは重複可能 |
| [std::type_index](stdlib_and_concepts.md#SS_3_8_3_3)    | 型情報型を連想コンテナのキーとして使用するためのクラス |
...
1. 関数の任意の型の[戻り値の無効表現](stdlib_and_concepts.md#SS_3_9_1)を持たせる
2. [オブジェクトの遅延初期化](stdlib_and_concepts.md#SS_3_9_2)する(初期化処理が重く、
