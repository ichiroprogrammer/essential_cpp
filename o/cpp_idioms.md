...
&emsp;&emsp; [コーディングスタイル](cpp_idioms.md#SS_4_8)  
&emsp;&emsp;&emsp; [AAAスタイル](cpp_idioms.md#SS_4_8_1)  
&emsp;&emsp;&emsp; [east-const](cpp_idioms.md#SS_4_8_2)  
&emsp;&emsp;&emsp; [west-const](cpp_idioms.md#SS_4_8_3)  

&emsp;&emsp; [オブジェクトのコピー](cpp_idioms.md#SS_4_9)  
&emsp;&emsp;&emsp; [シャローコピー](cpp_idioms.md#SS_4_9_1)  
&emsp;&emsp;&emsp; [ディープコピー](cpp_idioms.md#SS_4_9_2)  
&emsp;&emsp;&emsp; [スライシング](cpp_idioms.md#SS_4_9_3)  

&emsp;&emsp; [C++注意点](cpp_idioms.md#SS_4_10)  
&emsp;&emsp;&emsp; [オーバーライドとオーバーロードの違い](cpp_idioms.md#SS_4_10_1)  
&emsp;&emsp;&emsp; [danglingリファレンス](cpp_idioms.md#SS_4_10_2)  
&emsp;&emsp;&emsp; [danglingポインタ](cpp_idioms.md#SS_4_10_3)  
&emsp;&emsp;&emsp; [Most Vexing Parse](cpp_idioms.md#SS_4_10_4)  

&emsp;&emsp; [ソフトウェア一般](cpp_idioms.md#SS_4_11)  
&emsp;&emsp;&emsp; [ヒープ](cpp_idioms.md#SS_4_11_1)  
&emsp;&emsp;&emsp; [スレッドセーフ](cpp_idioms.md#SS_4_11_2)  
&emsp;&emsp;&emsp; [リエントラント](cpp_idioms.md#SS_4_11_3)  
&emsp;&emsp;&emsp; [クリティカルセクション](cpp_idioms.md#SS_4_11_4)  
&emsp;&emsp;&emsp; [スピンロック](cpp_idioms.md#SS_4_11_5)  
&emsp;&emsp;&emsp; [ミックスイン](cpp_idioms.md#SS_4_11_6)  
&emsp;&emsp;&emsp; [ハンドル](cpp_idioms.md#SS_4_11_7)  
&emsp;&emsp;&emsp; [フリースタンディング環境](cpp_idioms.md#SS_4_11_8)  
&emsp;&emsp;&emsp; [サイクロマティック複雑度](cpp_idioms.md#SS_4_11_9)  
&emsp;&emsp;&emsp; [凝集性](cpp_idioms.md#SS_4_11_10)  
&emsp;&emsp;&emsp;&emsp; [凝集性の欠如](cpp_idioms.md#SS_4_11_10_1)  
&emsp;&emsp;&emsp;&emsp; [LCOM](cpp_idioms.md#SS_4_11_10_2)  

&emsp;&emsp;&emsp; [Spurious Wakeup](cpp_idioms.md#SS_4_11_11)  
&emsp;&emsp;&emsp; [Static Initialization Order Fiasco(静的初期化順序問題)](cpp_idioms.md#SS_4_11_12)  
&emsp;&emsp;&emsp; [副作用](cpp_idioms.md#SS_4_11_13)  
&emsp;&emsp;&emsp; [Itanium C++ ABI](cpp_idioms.md#SS_4_11_14)  

&emsp;&emsp; [C++コンパイラ](cpp_idioms.md#SS_4_12)  
&emsp;&emsp;&emsp; [g++](cpp_idioms.md#SS_4_12_1)  
&emsp;&emsp;&emsp; [clang++](cpp_idioms.md#SS_4_12_2)  

&emsp;&emsp; [非ソフトウェア用語](cpp_idioms.md#SS_4_13)  
&emsp;&emsp;&emsp; [セマンティクス](cpp_idioms.md#SS_4_13_1)  
&emsp;&emsp;&emsp; [割れ窓理論](cpp_idioms.md#SS_4_13_2)  
&emsp;&emsp;&emsp; [車輪の再発明](cpp_idioms.md#SS_4_13_3)  
...
以下にこのパターンを使用した[ミックスイン](cpp_idioms.md#SS_4_11_6)の例を示す。
...
ような場合に使用する。
そのため[オープン・クローズドの原則(OCP)](essential_appendix.md#SS_5_4)の実装方法としても有用である。
...
bird::flyのオーバーライド関数(penguin::fly)について、[リスコフの置換原則(LSP)](essential_appendix.md#SS_5_2)に反した例を下記する。
...
* 下記のようなコードはstd::shared_ptrの仕様が想定する[セマンティクス](cpp_idioms.md#SS_4_13_1)に沿っておらず、
...
X、Yオブジェクトへの[ハンドル](cpp_idioms.md#SS_4_11_7)を完全に失った状態であり、X、Yオブジェクトを解放する手段はない。
...
下記に示す通り、このコードは、
[オープン・クローズドの原則(OCP)](essential_appendix.md#SS_5_4)にも対応した柔軟な構造を実現している。
...
原因は、copy代入で[スライシング](cpp_idioms.md#SS_4_9_3)が起こるためである。
...
[注] `templat<typename T> f(T&&)`の`T&&`は[forwardingリファレンス](core_lang_spec.md#SS_2_8_3)である。  
...
関数構造の適・不適については、[サイクロマティック複雑度](cpp_idioms.md#SS_4_11_9)によって下記テーブルのように定義する。
...
自動生成されるメンバ関数では、
複雑なリソース管理の要件を満たせないことがある(「[シャローコピー](cpp_idioms.md#SS_4_9_1)」参照)。
...
クラス構造の適・不適については、[LCOM](cpp_idioms.md#SS_4_11_10_2)によって下記テーブルのように定義する。
...
* `LCOM <= 0.4`  
  クラスが非常に凝集しており、[単一責任の原則(SRP)](essential_appendix.md#SS_5_3)を強く遵守している状態であるため、
  通常、デザインの見直しは不要である。
...
## コーディングスタイル <a id="SS_4_8"></a>
### AAAスタイル <a id="SS_4_8_1"></a>
...
## オブジェクトのコピー <a id="SS_4_9"></a>
### シャローコピー <a id="SS_4_9_1"></a>
シャローコピー(浅いコピー)とは、暗黙的、
もしくは=defaultによってコンパイラが生成するようなcopyコンストラクタ、
copy代入演算子が行うコピーであり、[ディープコピー](cpp_idioms.md#SS_4_9_2)と対比的に使われる概念である。
...
### ディープコピー <a id="SS_4_9_2"></a>
ディープコピーとは、[シャローコピー](cpp_idioms.md#SS_4_9_1)が発生させる問題を回避したコピーである。
...
## C++注意点 <a id="SS_4_10"></a>
### オーバーライドとオーバーロードの違い <a id="SS_4_10_1"></a>
...
### danglingリファレンス <a id="SS_4_10_2"></a>
...
### danglingポインタ <a id="SS_4_10_3"></a>
danglingポインタとは、[danglingリファレンス](cpp_idioms.md#SS_4_10_2)と同じような状態になったポインタを指す。


### Most Vexing Parse <a id="SS_4_10_4"></a>
...
## ソフトウェア一般 <a id="SS_4_11"></a>
### ヒープ <a id="SS_4_11_1"></a>
...
### ハンドル <a id="SS_4_11_7"></a>
CやC++の文脈でのハンドルとは、ポインタかリファレンスを指す。

### フリースタンディング環境 <a id="SS_4_11_8"></a>
...
#### 凝集性の欠如 <a id="SS_4_11_10_1"></a>
[凝集性](cpp_idioms.md#SS_4_11_10)の欠如(Lack of Cohesion in Methods/LCOM)とは、
...
#### LCOM <a id="SS_4_11_10_2"></a>
[凝集性の欠如](cpp_idioms.md#SS_4_11_10_1)とはLack of Cohesion in Methodsの和訳であり、LCOMと呼ばれる。

### Spurious Wakeup <a id="SS_4_11_11"></a>
...
### Static Initialization Order Fiasco(静的初期化順序問題) <a id="SS_4_11_12"></a>
静的初期化順序問題とは、
...
### Itanium C++ ABI <a id="SS_4_11_14"></a>
...
[g++](cpp_idioms.md#SS_4_12_1)や[clang++](cpp_idioms.md#SS_4_12_2)はx86/x86-64やARM64など多くのプラットフォームでもItaniumC++ABI準拠の規約を採用している。
...
## 非ソフトウェア用語 <a id="SS_4_13"></a>
### セマンティクス <a id="SS_4_13_1"></a>
